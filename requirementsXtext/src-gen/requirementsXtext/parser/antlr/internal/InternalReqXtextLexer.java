...
public class InternalReqXtextLexer extends Lexer {
	...
	public final void mRULE_ID() throws RecognitionException {
		try {
			int _type = RULE_ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalReqXtext.g:303:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
			// InternalReqXtext.g:303:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
			{
			// InternalReqXtext.g:303:11: ( '^' )?
			int alt1=2;
			...
			// InternalReqXtext.g:303:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
			loop2:
			while (true) {
				int alt2=2;
	...
	public final void mRULE_INT() throws RecognitionException {
		try {
			int _type = RULE_INT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalReqXtext.g:305:10: ( ( '0' .. '9' )+ )
			// InternalReqXtext.g:305:12: ( '0' .. '9' )+
			{
			// InternalReqXtext.g:305:12: ( '0' .. '9' )+
			int cnt3=0;
			loop3:
	...
	public final void mRULE_STRING() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalReqXtext.g:307:13: ( ( '\"' ( '\\\\' . |~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . |~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
			// InternalReqXtext.g:307:15: ( '\"' ( '\\\\' . |~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . |~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
			{
			// InternalReqXtext.g:307:15: ( '\"' ( '\\\\' . |~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . |~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
			int alt6=2;
			...
			switch (alt6) {
				case 1 :
					// InternalReqXtext.g:307:16: '\"' ( '\\\\' . |~ ( ( '\\\\' | '\"' ) ) )* '\"'
					{
					match('\"'); 
					// InternalReqXtext.g:307:20: ( '\\\\' . |~ ( ( '\\\\' | '\"' ) ) )*
					loop4:
					while (true) {
						int alt4=3;
					...
					break;
				case 2 :
					// InternalReqXtext.g:307:48: '\\'' ( '\\\\' . |~ ( ( '\\\\' | '\\'' ) ) )* '\\''
					{
					match('\''); 
					// InternalReqXtext.g:307:53: ( '\\\\' . |~ ( ( '\\\\' | '\\'' ) ) )*
					loop5:
					while (true) {
						int alt5=3;
	...
	public final void mRULE_ML_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalReqXtext.g:309:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// InternalReqXtext.g:309:19: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// InternalReqXtext.g:309:24: ( options {greedy=false; } : . )*
			loop7:
			while (true) {
				int alt7=2;
	...
	public final void mRULE_SL_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalReqXtext.g:311:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
			// InternalReqXtext.g:311:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
			{
			match("//"); 

			// InternalReqXtext.g:311:24: (~ ( ( '\\n' | '\\r' ) ) )*
			loop8:
			while (true) {
				int alt8=2;
	...
	public final void mRULE_WS() throws RecognitionException {
		try {
			int _type = RULE_WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalReqXtext.g:313:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
			// InternalReqXtext.g:313:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
			{
			// InternalReqXtext.g:313:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
			int cnt11=0;
			loop11:
	...
	public final void mRULE_ANY_OTHER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalReqXtext.g:315:16: ( . )
			// InternalReqXtext.g:315:18: .
			{
			matchAny(); 
			}
