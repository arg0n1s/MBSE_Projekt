...
public class XDuplexConnectionToConnectionRuleImpl extends AbstractRuleImpl
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, CableAttributes cableAttributes, XContainer xContainer,
		...
		Object[] result1_black = XDuplexConnectionToConnectionRuleImpl
				.pattern_XDuplexConnectionToConnectionRule_0_1_initialbindings_blackBBBBBBBBB(this, match,
						cableAttributes, xContainer, xDevice1, connection2, xCable, xDevice2, connection1);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[cableAttributes] = " + cableAttributes + ", " + "[xContainer] = "
					+ xContainer + ", " + "[xDevice1] = " + xDevice1 + ", " + "[connection2] = " + connection2 + ", "
					+ "[xCable] = " + xCable + ", " + "[xDevice2] = " + xDevice2 + ", " + "[connection1] = "
					+ connection1 + ".");
		}
		...
		if (XDuplexConnectionToConnectionRuleImpl
			...
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						...
						+ "[xDevice1] = " + xDevice1 + ", " + "[connection2] = " + connection2 + ", " + "[xCable] = "
						+ xCable + ", " + "[xDevice2] = " + xDevice2 + ", " + "[connection1] = " + connection1 + ".");
			}
			XDuplexConnectionToConnectionRuleImpl
					.pattern_XDuplexConnectionToConnectionRule_0_4_collectelementstobetranslated_greenBBBBBBBFFFF(match,
							cableAttributes, xDevice1, connection2, xCable, xDevice2, connection1);
			...
			//nothing EMoflonEdge connection2__xCable____incoming = (EMoflonEdge) result4_green[9];
			...
			XDuplexConnectionToConnectionRuleImpl
					.pattern_XDuplexConnectionToConnectionRule_0_5_collectcontextelements_greenBBBBBBBBFFFFFF(match,
							cableAttributes, xContainer, xDevice1, connection2, xCable, xDevice2, connection1);
			//nothing EMoflonEdge xContainer__xDevice1____elements = (EMoflonEdge) result5_green[8];
			//nothing EMoflonEdge xContainer__xDevice2____elements = (EMoflonEdge) result5_green[9];
			//nothing EMoflonEdge xDevice1__connection1____connections = (EMoflonEdge) result5_green[10];
			//nothing EMoflonEdge xContainer__xCable____elements = (EMoflonEdge) result5_green[11];
			//nothing EMoflonEdge xCable__cableAttributes____cableAttributes = (EMoflonEdge) result5_green[12];
			...
			XDuplexConnectionToConnectionRuleImpl
					.pattern_XDuplexConnectionToConnectionRule_0_6_registerobjectstomatch_expressionBBBBBBBBB(this,
							match, cableAttributes, xContainer, xDevice1, connection2, xCable, xDevice2, connection1);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Cable cable2 = (Cable) result1_bindingAndBlack[0];
		XDeviceToDevice xDeviceToDevice = (XDeviceToDevice) result1_bindingAndBlack[1];
		Container container = (Container) result1_bindingAndBlack[2];
		CableAttributes cableAttributes = (CableAttributes) result1_bindingAndBlack[3];
		XCableToCable xCableToCable1 = (XCableToCable) result1_bindingAndBlack[4];
		XContainer xContainer = (XContainer) result1_bindingAndBlack[5];
		XDevice xDevice1 = (XDevice) result1_bindingAndBlack[6];
		Cable cable1 = (Cable) result1_bindingAndBlack[7];
		Connections connection2 = (Connections) result1_bindingAndBlack[8];
		XCableToCable xCableToCable2 = (XCableToCable) result1_bindingAndBlack[9];
		XCable xCable = (XCable) result1_bindingAndBlack[10];
		XDevice xDevice2 = (XDevice) result1_bindingAndBlack[11];
		Connections connection1 = (Connections) result1_bindingAndBlack[12];
		Device device1 = (Device) result1_bindingAndBlack[13];
		Device device2 = (Device) result1_bindingAndBlack[14];
		XDeviceToDevice xDeviceToDevice2 = (XDeviceToDevice) result1_bindingAndBlack[15];
		//nothing CSP csp = (CSP) result1_bindingAndBlack[16];
		XDuplexConnectionToConnectionRuleImpl
				.pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_greenBBBB(cable2, cable1, device1,
						device2);
		...
		Object[] result3_black = XDuplexConnectionToConnectionRuleImpl
				.pattern_XDuplexConnectionToConnectionRule_1_3_bookkeepingforedges_blackBBBBBBBBBBBBBBBBB(ruleresult,
						cable2, xDeviceToDevice, container, cableAttributes, xCableToCable1, xContainer, xDevice1,
						cable1, connection2, xCableToCable2, xCable, xDevice2, connection1, device1, device2,
						xDeviceToDevice2);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[cable2] = " + cable2 + ", " + "[xDeviceToDevice] = " + xDeviceToDevice + ", "
					+ "[container] = " + container + ", " + "[cableAttributes] = " + cableAttributes + ", "
					+ "[xCableToCable1] = " + xCableToCable1 + ", " + "[xContainer] = " + xContainer + ", "
					+ "[xDevice1] = " + xDevice1 + ", " + "[cable1] = " + cable1 + ", " + "[connection2] = "
					+ connection2 + ", " + "[xCableToCable2] = " + xCableToCable2 + ", " + "[xCable] = " + xCable + ", "
					+ "[xDevice2] = " + xDevice2 + ", " + "[connection1] = " + connection1 + ", " + "[device1] = "
					+ device1 + ", " + "[device2] = " + device2 + ", " + "[xDeviceToDevice2] = " + xDeviceToDevice2
					+ ".");
		}
		XDuplexConnectionToConnectionRuleImpl
				.pattern_XDuplexConnectionToConnectionRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
						ruleresult, cable2, cableAttributes, xDevice1, cable1, connection2, xCable, xDevice2,
						connection1, device1, device2);
		//nothing EMoflonEdge cable2__device2____source = (EMoflonEdge) result3_green[11];
		//nothing EMoflonEdge device2__cable2____outgoing = (EMoflonEdge) result3_green[12];
		//nothing EMoflonEdge cableAttributes__xDevice2____endPoint2 = (EMoflonEdge) result3_green[13];
		...
		//nothing EMoflonEdge cable1__device2____target = (EMoflonEdge) result3_green[17];
		//nothing EMoflonEdge device2__cable1____incoming = (EMoflonEdge) result3_green[18];
		//nothing EMoflonEdge cable1__device1____source = (EMoflonEdge) result3_green[19];
		//nothing EMoflonEdge device1__cable1____outgoing = (EMoflonEdge) result3_green[20];
		//nothing EMoflonEdge connection2__xCable____incoming = (EMoflonEdge) result3_green[21];
		//nothing EMoflonEdge connection1__xCable____outgoing = (EMoflonEdge) result3_green[22];

		// 
		// 
		XDuplexConnectionToConnectionRuleImpl
				.pattern_XDuplexConnectionToConnectionRule_1_5_registerobjects_expressionBBBBBBBBBBBBBBBBBB(this,
						ruleresult, cable2, xDeviceToDevice, container, cableAttributes, xCableToCable1, xContainer,
						xDevice1, cable1, connection2, xCableToCable2, xCable, xDevice2, connection1, device1, device2,
						xDeviceToDevice2);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Connections connection1 = (Connections) result2_binding[6];
		for (Object[] result2_black : XDuplexConnectionToConnectionRuleImpl
				.pattern_XDuplexConnectionToConnectionRule_2_2_corematch_blackFFBFBBFBFBBBFFFB(cableAttributes,
						xContainer, xDevice1, connection2, xCable, xDevice2, connection1, match)) {
			Cable cable2 = (Cable) result2_black[0];
			XDeviceToDevice xDeviceToDevice = (XDeviceToDevice) result2_black[1];
			XCableToCable xCableToCable1 = (XCableToCable) result2_black[3];
			Cable cable1 = (Cable) result2_black[6];
			XCableToCable xCableToCable2 = (XCableToCable) result2_black[8];
			Device device1 = (Device) result2_black[12];
			Device device2 = (Device) result2_black[13];
			XDeviceToDevice xDeviceToDevice2 = (XDeviceToDevice) result2_black[14];
			// ForEach 
			for (Object[] result3_black : XDuplexConnectionToConnectionRuleImpl
					.pattern_XDuplexConnectionToConnectionRule_2_3_findcontext_blackBBFBBBBBBBBBBBBB(cable2,
							xDeviceToDevice, cableAttributes, xCableToCable1, xContainer, xDevice1, cable1, connection2,
							xCableToCable2, xCable, xDevice2, connection1, device1, device2, xDeviceToDevice2)) {
				Container container = (Container) result3_black[2];
				Object[] result3_green = XDuplexConnectionToConnectionRuleImpl
						.pattern_XDuplexConnectionToConnectionRule_2_3_findcontext_greenBBBBBBBBBBBBBBBBFFFFFFFFFFFFFFFFFFFFFFF(
								cable2, xDeviceToDevice, container, cableAttributes, xCableToCable1, xContainer,
								xDevice1, cable1, connection2, xCableToCable2, xCable, xDevice2, connection1, device1,
								device2, xDeviceToDevice2);
				...
				//nothing EMoflonEdge xContainer__xDevice1____elements = (EMoflonEdge) result3_green[19];
				...
				//nothing EMoflonEdge xDevice1__connection1____connections = (EMoflonEdge) result3_green[22];
				//nothing EMoflonEdge container__device1____devices = (EMoflonEdge) result3_green[23];
				//nothing EMoflonEdge container__cable2____cables = (EMoflonEdge) result3_green[24];
				//nothing EMoflonEdge xCableToCable1__cable1____target = (EMoflonEdge) result3_green[25];
				//nothing EMoflonEdge xContainer__xCable____elements = (EMoflonEdge) result3_green[26];
				//nothing EMoflonEdge container__cable1____cables = (EMoflonEdge) result3_green[27];
				//nothing EMoflonEdge xCableToCable2__cable2____target = (EMoflonEdge) result3_green[28];
				//nothing EMoflonEdge xCableToCable2__xCable____source = (EMoflonEdge) result3_green[29];
				//nothing EMoflonEdge xCableToCable1__xCable____source = (EMoflonEdge) result3_green[30];
				//nothing EMoflonEdge xCable__cableAttributes____cableAttributes = (EMoflonEdge) result3_green[31];
				//nothing EMoflonEdge container__device2____devices = (EMoflonEdge) result3_green[32];
				//nothing EMoflonEdge xDevice2__connection2____connections = (EMoflonEdge) result3_green[33];
				//nothing EMoflonEdge connection2__xCable____incoming = (EMoflonEdge) result3_green[34];
				//nothing EMoflonEdge connection1__xCable____outgoing = (EMoflonEdge) result3_green[35];
				//nothing EMoflonEdge xDeviceToDevice__device1____target = (EMoflonEdge) result3_green[36];
				//nothing EMoflonEdge xDeviceToDevice2__xDevice2____source = (EMoflonEdge) result3_green[37];
				//nothing EMoflonEdge xDeviceToDevice2__device2____target = (EMoflonEdge) result3_green[38];
				...
				Object[] result4_bindingAndBlack = XDuplexConnectionToConnectionRuleImpl
						.pattern_XDuplexConnectionToConnectionRule_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBBBBBBBBB(this,
								isApplicableMatch, cable2, xDeviceToDevice, container, cableAttributes, xCableToCable1,
								xContainer, xDevice1, cable1, connection2, xCableToCable2, xCable, xDevice2,
								connection1, device1, device2, xDeviceToDevice2);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[cable2] = " + cable2 + ", "
							+ "[xDeviceToDevice] = " + xDeviceToDevice + ", " + "[container] = " + container + ", "
							+ "[cableAttributes] = " + cableAttributes + ", " + "[xCableToCable1] = " + xCableToCable1
							+ ", " + "[xContainer] = " + xContainer + ", " + "[xDevice1] = " + xDevice1 + ", "
							+ "[cable1] = " + cable1 + ", " + "[connection2] = " + connection2 + ", "
							+ "[xCableToCable2] = " + xCableToCable2 + ", " + "[xCable] = " + xCable + ", "
							+ "[xDevice2] = " + xDevice2 + ", " + "[connection1] = " + connection1 + ", "
							+ "[device1] = " + device1 + ", " + "[device2] = " + device2 + ", "
							+ "[xDeviceToDevice2] = " + xDeviceToDevice2 + ".");
				}
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, CableAttributes cableAttributes, XContainer xContainer,
			XDevice xDevice1, Connections connection2, XCable xCable, XDevice xDevice2, Connections connection1) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, CableAttributes cableAttributes, XContainer xContainer,
			XDevice xDevice1, Connections connection2, XCable xCable, XDevice xDevice2, Connections connection1) {// Create CSP
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Cable cable2,
			XDeviceToDevice xDeviceToDevice, Container container, CableAttributes cableAttributes,
			XCableToCable xCableToCable1, XContainer xContainer, XDevice xDevice1, Cable cable1,
			Connections connection2, XCableToCable xCableToCable2, XCable xCable, XDevice xDevice2,
			Connections connection1, Device device1, Device device2, XDeviceToDevice xDeviceToDevice2) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject cable2, EObject xDeviceToDevice,
			EObject container, EObject cableAttributes, EObject xCableToCable1, EObject xContainer, EObject xDevice1,
			EObject cable1, EObject connection2, EObject xCableToCable2, EObject xCable, EObject xDevice2,
			EObject connection1, EObject device1, EObject device2, EObject xDeviceToDevice2) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Cable cable2, Container container, Cable cable1, Device device1,
			Device device2) {

		Object[] result1_black = XDuplexConnectionToConnectionRuleImpl
				.pattern_XDuplexConnectionToConnectionRule_10_1_initialbindings_blackBBBBBBB(this, match, cable2,
						container, cable1, device1, device2);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[cable2] = " + cable2 + ", " + "[container] = " + container + ", "
					+ "[cable1] = " + cable1 + ", " + "[device1] = " + device1 + ", " + "[device2] = " + device2 + ".");
		}

		Object[] result2_bindingAndBlack = XDuplexConnectionToConnectionRuleImpl
				.pattern_XDuplexConnectionToConnectionRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(this, match, cable2,
						container, cable1, device1, device2);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[cable2] = " + cable2 + ", " + "[container] = " + container + ", "
		...
		if (XDuplexConnectionToConnectionRuleImpl
			...
			Object[] result4_black = XDuplexConnectionToConnectionRuleImpl
					.pattern_XDuplexConnectionToConnectionRule_10_4_collectelementstobetranslated_blackBBBBBB(match,
							cable2, container, cable1, device1, device2);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[cable2] = " + cable2 + ", " + "[container] = " + container + ", " + "[cable1] = " + cable1
						+ ", " + "[device1] = " + device1 + ", " + "[device2] = " + device2 + ".");
			}
			XDuplexConnectionToConnectionRuleImpl
					.pattern_XDuplexConnectionToConnectionRule_10_4_collectelementstobetranslated_greenBBBBBFFFFFFFF(
							match, cable2, cable1, device1, device2);
			...
			Object[] result5_black = XDuplexConnectionToConnectionRuleImpl
					.pattern_XDuplexConnectionToConnectionRule_10_5_collectcontextelements_blackBBBBBB(match, cable2,
							container, cable1, device1, device2);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[cable2] = " + cable2 + ", " + "[container] = " + container + ", " + "[cable1] = " + cable1
			...
			//nothing EMoflonEdge container__cable2____cables = (EMoflonEdge) result5_green[7];
			//nothing EMoflonEdge container__cable1____cables = (EMoflonEdge) result5_green[8];
			//nothing EMoflonEdge container__device2____devices = (EMoflonEdge) result5_green[9];

			// 
			XDuplexConnectionToConnectionRuleImpl
					.pattern_XDuplexConnectionToConnectionRule_10_6_registerobjectstomatch_expressionBBBBBBB(this,
							match, cable2, container, cable1, device1, device2);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[16];
		XDuplexConnectionToConnectionRuleImpl
				.pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_greenBBBBBB(cableAttributes,
						xDevice1, connection2, xCable, xDevice2, connection1);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		Cable cable2 = (Cable) result2_binding[0];
		Container container = (Container) result2_binding[1];
		Cable cable1 = (Cable) result2_binding[2];
		Device device1 = (Device) result2_binding[3];
		Device device2 = (Device) result2_binding[4];
		for (Object[] result2_black : XDuplexConnectionToConnectionRuleImpl
				.pattern_XDuplexConnectionToConnectionRule_12_2_corematch_blackBFBFFBFFFBBFB(cable2, container, cable1,
						device1, device2, match)) {
			XDeviceToDevice xDeviceToDevice = (XDeviceToDevice) result2_black[1];
			XCableToCable xCableToCable1 = (XCableToCable) result2_black[3];
			XDevice xDevice1 = (XDevice) result2_black[4];
			...
			// ForEach 
			for (Object[] result3_black : XDuplexConnectionToConnectionRuleImpl
					.pattern_XDuplexConnectionToConnectionRule_12_3_findcontext_blackBBBFBFBBFBBBFBBB(cable2,
							xDeviceToDevice, container, xCableToCable1, xDevice1, cable1, xCableToCable2, xCable,
							xDevice2, device1, device2, xDeviceToDevice2)) {
				CableAttributes cableAttributes = (CableAttributes) result3_black[3];
				XContainer xContainer = (XContainer) result3_black[5];
				Connections connection2 = (Connections) result3_black[8];
				...
				//nothing EMoflonEdge xDevice1__connection1____connections = (EMoflonEdge) result3_green[22];
				//nothing EMoflonEdge container__device1____devices = (EMoflonEdge) result3_green[23];
				//nothing EMoflonEdge cable2__device1____target = (EMoflonEdge) result3_green[24];
				//nothing EMoflonEdge device1__cable2____incoming = (EMoflonEdge) result3_green[25];
				//nothing EMoflonEdge container__cable2____cables = (EMoflonEdge) result3_green[26];
				//nothing EMoflonEdge cable1__device2____target = (EMoflonEdge) result3_green[27];
				//nothing EMoflonEdge device2__cable1____incoming = (EMoflonEdge) result3_green[28];
				//nothing EMoflonEdge cable1__device1____source = (EMoflonEdge) result3_green[29];
				//nothing EMoflonEdge device1__cable1____outgoing = (EMoflonEdge) result3_green[30];
				...
				//nothing EMoflonEdge container__cable1____cables = (EMoflonEdge) result3_green[33];
				//nothing EMoflonEdge xCableToCable2__cable2____target = (EMoflonEdge) result3_green[34];
				//nothing EMoflonEdge xCableToCable2__xCable____source = (EMoflonEdge) result3_green[35];
				//nothing EMoflonEdge xCableToCable1__xCable____source = (EMoflonEdge) result3_green[36];
				...
				//nothing EMoflonEdge xDevice2__connection2____connections = (EMoflonEdge) result3_green[39];
				//nothing EMoflonEdge xDeviceToDevice__device1____target = (EMoflonEdge) result3_green[40];
				//nothing EMoflonEdge xDeviceToDevice2__xDevice2____source = (EMoflonEdge) result3_green[41];
				//nothing EMoflonEdge xDeviceToDevice2__device2____target = (EMoflonEdge) result3_green[42];

				Object[] result4_bindingAndBlack = XDuplexConnectionToConnectionRuleImpl
						.pattern_XDuplexConnectionToConnectionRule_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBBBBBBBB(
								this, isApplicableMatch, cable2, xDeviceToDevice, container, cableAttributes,
								xCableToCable1, xContainer, xDevice1, cable1, connection2, xCableToCable2, xCable,
								xDevice2, connection1, device1, device2, xDeviceToDevice2);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[cable2] = " + cable2 + ", "
							+ "[xDeviceToDevice] = " + xDeviceToDevice + ", " + "[container] = " + container + ", "
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, Cable cable2, Container container, Cable cable1, Device device1,
			Device device2) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, Cable cable2, Container container, Cable cable1, Device device1,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Cable cable2,
			XDeviceToDevice xDeviceToDevice, Container container, CableAttributes cableAttributes,
			XCableToCable xCableToCable1, XContainer xContainer, XDevice xDevice1, Cable cable1,
			Connections connection2, XCableToCable xCableToCable2, XCable xCable, XDevice xDevice2,
			Connections connection1, Device device1, Device device2, XDeviceToDevice xDeviceToDevice2) {// Create CSP
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject cable2, EObject xDeviceToDevice,
			EObject container, EObject cableAttributes, EObject xCableToCable1, EObject xContainer, EObject xDevice1,
			EObject cable1, EObject connection2, EObject xCableToCable2, EObject xCable, EObject xDevice2,
			EObject connection1, EObject device1, EObject device2, EObject xDeviceToDevice2) {
		ruleresult.registerObject("cable2", cable2);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_13(EMoflonEdge _edge_source) {
		...
		for (Object[] result2_black : XDuplexConnectionToConnectionRuleImpl
			...
			Cable cable1 = (Cable) result2_black[2];
			Device device1 = (Device) result2_black[3];
			Device device2 = (Device) result2_black[4];
			Object[] result2_green = XDuplexConnectionToConnectionRuleImpl
			...
			if (XDuplexConnectionToConnectionRuleImpl
					.pattern_XDuplexConnectionToConnectionRule_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
							this, match, cable2, container, cable1, device1, device2)) {
				// 
				if (XDuplexConnectionToConnectionRuleImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_9(EMoflonEdge _edge_endPoint2) {
		...
		for (Object[] result2_black : XDuplexConnectionToConnectionRuleImpl
			...
			Connections connection1 = (Connections) result2_black[6];
			Object[] result2_green = XDuplexConnectionToConnectionRuleImpl
			...
			if (XDuplexConnectionToConnectionRuleImpl
					.pattern_XDuplexConnectionToConnectionRule_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBBBB(
							this, match, cableAttributes, xContainer, xDevice1, connection2, xCable, xDevice2,
							connection1)) {
				// 
				if (XDuplexConnectionToConnectionRuleImpl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Cable cable2 = (Cable) result2_bindingAndBlack[0];
		Container container = (Container) result2_bindingAndBlack[1];
		CableAttributes cableAttributes = (CableAttributes) result2_bindingAndBlack[2];
		XContainer xContainer = (XContainer) result2_bindingAndBlack[3];
		XDevice xDevice1 = (XDevice) result2_bindingAndBlack[4];
		Cable cable1 = (Cable) result2_bindingAndBlack[5];
		Connections connection2 = (Connections) result2_bindingAndBlack[6];
		XCable xCable = (XCable) result2_bindingAndBlack[7];
		XDevice xDevice2 = (XDevice) result2_bindingAndBlack[8];
		Connections connection1 = (Connections) result2_bindingAndBlack[9];
		Device device1 = (Device) result2_bindingAndBlack[10];
		Device device2 = (Device) result2_bindingAndBlack[11];

		Object[] result3_bindingAndBlack = XDuplexConnectionToConnectionRuleImpl
				.pattern_XDuplexConnectionToConnectionRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBBBBBB(this, cable2,
						container, cableAttributes, xContainer, xDevice1, cable1, connection2, xCable, xDevice2,
						connection1, device1, device2, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[cable2] = " + cable2 + ", " + "[container] = " + container + ", " + "[cableAttributes] = "
					+ cableAttributes + ", " + "[xContainer] = " + xContainer + ", " + "[xDevice1] = " + xDevice1 + ", "
					+ "[cable1] = " + cable1 + ", " + "[connection2] = " + connection2 + ", " + "[xCable] = " + xCable
					+ ", " + "[xDevice2] = " + xDevice2 + ", " + "[connection1] = " + connection1 + ", "
					+ "[device1] = " + device1 + ", " + "[device2] = " + device2 + ", " + "[sourceMatch] = "
		...
		if (XDuplexConnectionToConnectionRuleImpl
			...
			for (Object[] result5_black : XDuplexConnectionToConnectionRuleImpl
					.pattern_XDuplexConnectionToConnectionRule_24_5_matchcorrcontext_blackBFFBBFBBBBFBB(cable2,
							xDevice1, cable1, xCable, xDevice2, device1, device2, sourceMatch, targetMatch)) {
				XDeviceToDevice xDeviceToDevice = (XDeviceToDevice) result5_black[1];
				XCableToCable xCableToCable1 = (XCableToCable) result5_black[2];
				XCableToCable xCableToCable2 = (XCableToCable) result5_black[5];
				XDeviceToDevice xDeviceToDevice2 = (XDeviceToDevice) result5_black[10];
				...
				Object[] result6_black = XDuplexConnectionToConnectionRuleImpl
						.pattern_XDuplexConnectionToConnectionRule_24_6_createcorrespondence_blackBBBBBBBBBBBBB(cable2,
								container, cableAttributes, xContainer, xDevice1, cable1, connection2, xCable, xDevice2,
								connection1, device1, device2, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[cable2] = " + cable2
							+ ", " + "[container] = " + container + ", " + "[cableAttributes] = " + cableAttributes
							+ ", " + "[xContainer] = " + xContainer + ", " + "[xDevice1] = " + xDevice1 + ", "
							+ "[cable1] = " + cable1 + ", " + "[connection2] = " + connection2 + ", " + "[xCable] = "
							+ xCable + ", " + "[xDevice2] = " + xDevice2 + ", " + "[connection1] = " + connection1
							+ ", " + "[device1] = " + device1 + ", " + "[device2] = " + device2 + ", " + "[ccMatch] = "
							+ ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Cable cable2, Container container, CableAttributes cableAttributes,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(CableAttributes cableAttributes, XContainer xContainer, XDevice xDevice1,
			Connections connection2, XCable xCable, XDevice xDevice2, Connections connection1) {// 
		Object[] result1_black = XDuplexConnectionToConnectionRuleImpl
				.pattern_XDuplexConnectionToConnectionRule_27_1_matchtggpattern_blackBBBBBBB(cableAttributes,
						xContainer, xDevice1, connection2, xCable, xDevice2, connection1);
		if (result1_black != null) {
			XDuplexConnectionToConnectionRuleImpl
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Cable cable2, Container container, Cable cable1, Device device1, Device device2) {// 
		Object[] result1_black = XDuplexConnectionToConnectionRuleImpl
				.pattern_XDuplexConnectionToConnectionRule_28_1_matchtggpattern_blackBBBBB(cable2, container, cable1,
						device1, device2);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : XDuplexConnectionToConnectionRuleImpl
			...
			XCable xCable = (XCable) result2_black[12];
			CableAttributes cableAttributes = (CableAttributes) result2_black[13];
			XCableToCable xCableToCable2 = (XCableToCable) result2_black[14];
			...
			Object[] result3_bindingAndBlack = XDuplexConnectionToConnectionRuleImpl
					.pattern_XDuplexConnectionToConnectionRule_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBBBBBBBBB(this,
							isApplicableMatch, cable2, xDeviceToDevice, container, cableAttributes, xCableToCable1,
							xContainer, xDevice1, cable1, connection2, xCableToCable2, xCable, xDevice2, connection1,
							device1, device2, xDeviceToDevice2, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[cable2] = " + cable2 + ", "
						+ "[xDeviceToDevice] = " + xDeviceToDevice + ", " + "[container] = " + container + ", "
			...
			if (XDuplexConnectionToConnectionRuleImpl
				...
				// 
				Object[] result5_black = XDuplexConnectionToConnectionRuleImpl
						.pattern_XDuplexConnectionToConnectionRule_29_5_checknacs_blackBBBBBBBBBBBBBBBB(cable2,
								xDeviceToDevice, container, cableAttributes, xCableToCable1, xContainer, xDevice1,
								cable1, connection2, xCableToCable2, xCable, xDevice2, connection1, device1, device2,
								xDeviceToDevice2);
				if (result5_black != null) {
					XDuplexConnectionToConnectionRuleImpl
					...
					Object[] result6_black = XDuplexConnectionToConnectionRuleImpl
							.pattern_XDuplexConnectionToConnectionRule_29_6_perform_blackBBBBBBBBBBBBBBBBB(cable2,
									xDeviceToDevice, container, cableAttributes, xCableToCable1, xContainer, xDevice1,
									cable1, connection2, xCableToCable2, xCable, xDevice2, connection1, device1,
									device2, xDeviceToDevice2, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[cable2] = " + cable2
								+ ", " + "[xDeviceToDevice] = " + xDeviceToDevice + ", " + "[container] = " + container
								+ ", " + "[cableAttributes] = " + cableAttributes + ", " + "[xCableToCable1] = "
								+ xCableToCable1 + ", " + "[xContainer] = " + xContainer + ", " + "[xDevice1] = "
								+ xDevice1 + ", " + "[cable1] = " + cable1 + ", " + "[connection2] = " + connection2
								+ ", " + "[xCableToCable2] = " + xCableToCable2 + ", " + "[xCable] = " + xCable + ", "
								+ "[xDevice2] = " + xDevice2 + ", " + "[connection1] = " + connection1 + ", "
								+ "[device1] = " + device1 + ", " + "[device2] = " + device2 + ", "
								+ "[xDeviceToDevice2] = " + xDeviceToDevice2 + ", " + "[ruleResult] = " + ruleResult
								+ ".");
					}
					XDuplexConnectionToConnectionRuleImpl
							.pattern_XDuplexConnectionToConnectionRule_29_6_perform_greenBBBBBBBBBBB(cable2,
									cableAttributes, xDevice1, cable1, connection2, xCable, xDevice2, connection1,
									device1, device2, ruleResult);
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Cable cable2,
			XDeviceToDevice xDeviceToDevice, Container container, CableAttributes cableAttributes,
			XCableToCable xCableToCable1, XContainer xContainer, XDevice xDevice1, Cable cable1,
			Connections connection2, XCableToCable xCableToCable2, XCable xCable, XDevice xDevice2,
			Connections connection1, Device device1, Device device2, XDeviceToDevice xDeviceToDevice2,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.XDUPLEX_CONNECTION_TO_CONNECTION_RULE___IS_APPROPRIATE_FWD__MATCH_CABLEATTRIBUTES_XCONTAINER_XDEVICE_CONNECTIONS_XCABLE_XDEVICE_CONNECTIONS:
			return isAppropriate_FWD((Match) arguments.get(0), (CableAttributes) arguments.get(1),
					(XContainer) arguments.get(2), (XDevice) arguments.get(3), (Connections) arguments.get(4),
					(XCable) arguments.get(5), (XDevice) arguments.get(6), (Connections) arguments.get(7));
		...
		case RulesPackage.XDUPLEX_CONNECTION_TO_CONNECTION_RULE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_CABLEATTRIBUTES_XCONTAINER_XDEVICE_CONNECTIONS_XCABLE_XDEVICE_CONNECTIONS:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (CableAttributes) arguments.get(1),
					(XContainer) arguments.get(2), (XDevice) arguments.get(3), (Connections) arguments.get(4),
					(XCable) arguments.get(5), (XDevice) arguments.get(6), (Connections) arguments.get(7));
			return null;
		case RulesPackage.XDUPLEX_CONNECTION_TO_CONNECTION_RULE___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_CABLEATTRIBUTES_XCONTAINER_XDEVICE_CONNECTIONS_XCABLE_XDEVICE_CONNECTIONS:
		...
		case RulesPackage.XDUPLEX_CONNECTION_TO_CONNECTION_RULE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CABLE_XDEVICETODEVICE_CONTAINER_CABLEATTRIBUTES_XCABLETOCABLE_XCONTAINER_XDEVICE_CABLE_CONNECTIONS_XCABLETOCABLE_XCABLE_XDEVICE_CONNECTIONS_DEVICE_DEVICE_XDEVICETODEVICE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Cable) arguments.get(1),
					(XDeviceToDevice) arguments.get(2), (Container) arguments.get(3),
					(CableAttributes) arguments.get(4), (XCableToCable) arguments.get(5), (XContainer) arguments.get(6),
					(XDevice) arguments.get(7), (Cable) arguments.get(8), (Connections) arguments.get(9),
					(XCableToCable) arguments.get(10), (XCable) arguments.get(11), (XDevice) arguments.get(12),
					(Connections) arguments.get(13), (Device) arguments.get(14), (Device) arguments.get(15),
					(XDeviceToDevice) arguments.get(16));
		...
		case RulesPackage.XDUPLEX_CONNECTION_TO_CONNECTION_RULE___IS_APPROPRIATE_BWD__MATCH_CABLE_CONTAINER_CABLE_DEVICE_DEVICE:
			return isAppropriate_BWD((Match) arguments.get(0), (Cable) arguments.get(1), (Container) arguments.get(2),
					(Cable) arguments.get(3), (Device) arguments.get(4), (Device) arguments.get(5));
		...
		case RulesPackage.XDUPLEX_CONNECTION_TO_CONNECTION_RULE___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_CABLE_CONTAINER_CABLE_DEVICE_DEVICE:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (Cable) arguments.get(1), (Container) arguments.get(2),
					(Cable) arguments.get(3), (Device) arguments.get(4), (Device) arguments.get(5));
			return null;
		case RulesPackage.XDUPLEX_CONNECTION_TO_CONNECTION_RULE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_CABLE_CONTAINER_CABLE_DEVICE_DEVICE:
		...
		case RulesPackage.XDUPLEX_CONNECTION_TO_CONNECTION_RULE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CABLE_XDEVICETODEVICE_CONTAINER_CABLEATTRIBUTES_XCABLETOCABLE_XCONTAINER_XDEVICE_CABLE_CONNECTIONS_XCABLETOCABLE_XCABLE_XDEVICE_CONNECTIONS_DEVICE_DEVICE_XDEVICETODEVICE:
		...
		case RulesPackage.XDUPLEX_CONNECTION_TO_CONNECTION_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_13__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_13((EMoflonEdge) arguments.get(0));
		case RulesPackage.XDUPLEX_CONNECTION_TO_CONNECTION_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_9__EMOFLONEDGE:
		...
		case RulesPackage.XDUPLEX_CONNECTION_TO_CONNECTION_RULE___IS_APPLICABLE_SOLVE_CSP_CC__CABLE_CONTAINER_CABLEATTRIBUTES_XCONTAINER_XDEVICE_CABLE_CONNECTIONS_XCABLE_XDEVICE_CONNECTIONS_DEVICE_DEVICE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Cable) arguments.get(0), (Container) arguments.get(1),
					(CableAttributes) arguments.get(2), (XContainer) arguments.get(3), (XDevice) arguments.get(4),
					(Cable) arguments.get(5), (Connections) arguments.get(6), (XCable) arguments.get(7),
					(XDevice) arguments.get(8), (Connections) arguments.get(9), (Device) arguments.get(10),
		...
		case RulesPackage.XDUPLEX_CONNECTION_TO_CONNECTION_RULE___CHECK_DEC_FWD__CABLEATTRIBUTES_XCONTAINER_XDEVICE_CONNECTIONS_XCABLE_XDEVICE_CONNECTIONS:
			return checkDEC_FWD((CableAttributes) arguments.get(0), (XContainer) arguments.get(1),
					(XDevice) arguments.get(2), (Connections) arguments.get(3), (XCable) arguments.get(4),
					(XDevice) arguments.get(5), (Connections) arguments.get(6));
		case RulesPackage.XDUPLEX_CONNECTION_TO_CONNECTION_RULE___CHECK_DEC_BWD__CABLE_CONTAINER_CABLE_DEVICE_DEVICE:
			return checkDEC_BWD((Cable) arguments.get(0), (Container) arguments.get(1), (Cable) arguments.get(2),
		...
		case RulesPackage.XDUPLEX_CONNECTION_TO_CONNECTION_RULE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CABLE_XDEVICETODEVICE_CONTAINER_CABLEATTRIBUTES_XCABLETOCABLE_XCONTAINER_XDEVICE_CABLE_CONNECTIONS_XCABLETOCABLE_XCABLE_XDEVICE_CONNECTIONS_DEVICE_DEVICE_XDEVICETODEVICE_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Cable) arguments.get(1),
					...
					(XCableToCable) arguments.get(10), (XCable) arguments.get(11), (XDevice) arguments.get(12),
					(Connections) arguments.get(13), (Device) arguments.get(14), (Device) arguments.get(15),
					(XDeviceToDevice) arguments.get(16), (ModelgeneratorRuleResult) arguments.get(17));
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_0_1_initialbindings_blackBBBBBBBBB(
			XDuplexConnectionToConnectionRule _this, Match match, CableAttributes cableAttributes,
			XContainer xContainer, XDevice xDevice1, Connections connection2, XCable xCable, XDevice xDevice2,
			Connections connection1) {
		if (!xDevice1.equals(xDevice2)) {
			if (!connection1.equals(connection2)) {
				return new Object[] { _this, match, cableAttributes, xContainer, xDevice1, connection2, xCable,
						xDevice2, connection1 };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_0_2_SolveCSP_bindingFBBBBBBBBB(
			...
			XContainer xContainer, XDevice xDevice1, Connections connection2, XCable xCable, XDevice xDevice2,
			Connections connection1) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, cableAttributes, xContainer, xDevice1,
				connection2, xCable, xDevice2, connection1);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, cableAttributes, xContainer, xDevice1, connection2, xCable,
					xDevice2, connection1 };
		}
		return null;
	}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_0_2_SolveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_XDuplexConnectionToConnectionRule_0_2_SolveCSP_binding = pattern_XDuplexConnectionToConnectionRule_0_2_SolveCSP_bindingFBBBBBBBBB(
				_this, match, cableAttributes, xContainer, xDevice1, connection2, xCable, xDevice2, connection1);
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_0_4_collectelementstobetranslated_blackBBBBBBBB(
			Match match, CableAttributes cableAttributes, XContainer xContainer, XDevice xDevice1,
			Connections connection2, XCable xCable, XDevice xDevice2, Connections connection1) {
		if (!xDevice1.equals(xDevice2)) {
			if (!connection1.equals(connection2)) {
				return new Object[] { match, cableAttributes, xContainer, xDevice1, connection2, xCable, xDevice2,
						connection1 };
			}
		}
		return null;
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_0_4_collectelementstobetranslated_greenBBBBBBBFFFF(
			Match match, CableAttributes cableAttributes, XDevice xDevice1, Connections connection2, XCable xCable,
			XDevice xDevice2, Connections connection1) {
		...
		return new Object[] { match, cableAttributes, xDevice1, connection2, xCable, xDevice2, connection1,
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_0_5_collectcontextelements_greenBBBBBBBBFFFFFF(
		...
		return new Object[] { match, cableAttributes, xContainer, xDevice1, connection2, xCable, xDevice2, connection1,
				xContainer__xDevice1____elements, xContainer__xDevice2____elements,
	...
	public static final void pattern_XDuplexConnectionToConnectionRule_0_6_registerobjectstomatch_expressionBBBBBBBBB(
			...
			XContainer xContainer, XDevice xDevice1, Connections connection2, XCable xCable, XDevice xDevice2,
			Connections connection1) {
		_this.registerObjectsToMatch_FWD(match, cableAttributes, xContainer, xDevice1, connection2, xCable, xDevice2,
				connection1);
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_bindingFFFFFFFFFFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
		EObject _localVariable_0 = isApplicableMatch.getObject("cable2");
		EObject _localVariable_1 = isApplicableMatch.getObject("xDeviceToDevice");
		EObject _localVariable_2 = isApplicableMatch.getObject("container");
		EObject _localVariable_3 = isApplicableMatch.getObject("cableAttributes");
		EObject _localVariable_4 = isApplicableMatch.getObject("xCableToCable1");
		EObject _localVariable_5 = isApplicableMatch.getObject("xContainer");
		EObject _localVariable_6 = isApplicableMatch.getObject("xDevice1");
		EObject _localVariable_7 = isApplicableMatch.getObject("cable1");
		EObject _localVariable_8 = isApplicableMatch.getObject("connection2");
		...
		EObject _localVariable_11 = isApplicableMatch.getObject("xDevice2");
		EObject _localVariable_12 = isApplicableMatch.getObject("connection1");
		EObject _localVariable_13 = isApplicableMatch.getObject("device1");
		EObject _localVariable_14 = isApplicableMatch.getObject("device2");
		EObject _localVariable_15 = isApplicableMatch.getObject("xDeviceToDevice2");
		EObject tmpCable2 = _localVariable_0;
		...
		EObject tmpXCableToCable1 = _localVariable_4;
		EObject tmpXContainer = _localVariable_5;
		EObject tmpXDevice1 = _localVariable_6;
		EObject tmpCable1 = _localVariable_7;
		EObject tmpConnection2 = _localVariable_8;
		EObject tmpXCableToCable2 = _localVariable_9;
		EObject tmpXCable = _localVariable_10;
		EObject tmpXDevice2 = _localVariable_11;
		EObject tmpConnection1 = _localVariable_12;
		EObject tmpDevice1 = _localVariable_13;
		EObject tmpDevice2 = _localVariable_14;
		EObject tmpXDeviceToDevice2 = _localVariable_15;
															...
															if (tmpDevice1 instanceof Device) {
																...
																if (tmpDevice2 instanceof Device) {
																	...
																	if (tmpXDeviceToDevice2 instanceof XDeviceToDevice) {
																		...
																		return new Object[] { cable2, xDeviceToDevice,
																				container, cableAttributes,
																				xCableToCable1, xContainer, xDevice1,
																				cable1, connection2, xCableToCable2,
																				xCable, xDevice2, connection1, device1,
																				device2, xDeviceToDevice2,
																				isApplicableMatch };
																	}
																}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_blackBBBBBBBBBBBBBBBBFBB(
			Cable cable2, XDeviceToDevice xDeviceToDevice, Container container, CableAttributes cableAttributes,
			XCableToCable xCableToCable1, XContainer xContainer, XDevice xDevice1, Cable cable1,
			Connections connection2, XCableToCable xCableToCable2, XCable xCable, XDevice xDevice2,
			Connections connection1, Device device1, Device device2, XDeviceToDevice xDeviceToDevice2,
							...
							if (!device1.equals(device2)) {
								for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
									if (tmpCsp instanceof CSP) {
										CSP csp = (CSP) tmpCsp;
										return new Object[] { cable2, xDeviceToDevice, container, cableAttributes,
												xCableToCable1, xContainer, xDevice1, cable1, connection2,
												xCableToCable2, xCable, xDevice2, connection1, device1, device2,
												xDeviceToDevice2, csp, _this, isApplicableMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_bindingAndBlackFFFFFFFFFFFFFFFFFBB(
		...
		if (result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_binding != null) {
			Cable cable2 = (Cable) result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_binding[0];
			XDeviceToDevice xDeviceToDevice = (XDeviceToDevice) result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_binding[1];
			Container container = (Container) result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_binding[2];
			CableAttributes cableAttributes = (CableAttributes) result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_binding[3];
			XCableToCable xCableToCable1 = (XCableToCable) result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_binding[4];
			XContainer xContainer = (XContainer) result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_binding[5];
			XDevice xDevice1 = (XDevice) result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_binding[6];
			Cable cable1 = (Cable) result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_binding[7];
			Connections connection2 = (Connections) result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_binding[8];
			...
			XDevice xDevice2 = (XDevice) result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_binding[11];
			...
			Device device1 = (Device) result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_binding[13];
			Device device2 = (Device) result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_binding[14];
			XDeviceToDevice xDeviceToDevice2 = (XDeviceToDevice) result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_binding[15];
			...
			Object[] result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_black = pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_blackBBBBBBBBBBBBBBBBFBB(
					cable2, xDeviceToDevice, container, cableAttributes, xCableToCable1, xContainer, xDevice1, cable1,
					connection2, xCableToCable2, xCable, xDevice2, connection1, device1, device2, xDeviceToDevice2,
			...
			if (result_pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_black != null) {
				...
				return new Object[] { cable2, xDeviceToDevice, container, cableAttributes, xCableToCable1, xContainer,
						xDevice1, cable1, connection2, xCableToCable2, xCable, xDevice2, connection1, device1, device2,
						xDeviceToDevice2, csp, _this, isApplicableMatch };
			}
		}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_1_1_performtransformation_greenBBBB(
			Cable cable2, Cable cable1, Device device1, Device device2) {
		cable2.setSource(device2);
		cable2.setTarget(device1);
		cable1.setTarget(device2);
		cable1.setSource(device1);
		return new Object[] { cable2, cable1, device1, device2 };
	}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_1_3_bookkeepingforedges_blackBBBBBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject cable2, EObject xDeviceToDevice, EObject container,
		...
		if (!cable2.equals(xDeviceToDevice)) {
			if (!cable2.equals(container)) {
				if (!cable2.equals(cableAttributes)) {
					if (!cable2.equals(xCableToCable1)) {
						if (!cable2.equals(xContainer)) {
							if (!cable2.equals(xDevice1)) {
								if (!cable2.equals(connection2)) {
									if (!cable2.equals(xCableToCable2)) {
										if (!cable2.equals(xCable)) {
											if (!cable2.equals(xDevice2)) {
												if (!cable2.equals(connection1)) {
													if (!cable2.equals(device1)) {
														if (!cable2.equals(device2)) {
															if (!cable2.equals(xDeviceToDevice2)) {
																if (!xDeviceToDevice.equals(xDeviceToDevice2)) {
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject cable2, EObject cableAttributes, EObject xDevice1, EObject cable1,
			EObject connection2, EObject xCable, EObject xDevice2, EObject connection1, EObject device1,
			EObject device2) {
		...
		connection2__xCable____incoming.setName(connection2__xCable____incoming_name_prime);
		connection1__xCable____outgoing.setName(connection1__xCable____outgoing_name_prime);
		return new Object[] { ruleresult, cable2, cableAttributes, xDevice1, cable1, connection2, xCable, xDevice2,
				connection1, device1, device2, cable2__device2____source, device2__cable2____outgoing,
				cableAttributes__xDevice2____endPoint2, cableAttributes__xDevice1____endPoint1,
				cable2__device1____target, device1__cable2____incoming, cable1__device2____target,
				device2__cable1____incoming, cable1__device1____source, device1__cable1____outgoing,
				connection2__xCable____incoming, connection1__xCable____outgoing };
	}

	public static final void pattern_XDuplexConnectionToConnectionRule_1_5_registerobjects_expressionBBBBBBBBBBBBBBBBBB(
			XDuplexConnectionToConnectionRule _this, PerformRuleResult ruleresult, EObject cable2,
			EObject xDeviceToDevice, EObject container, EObject cableAttributes, EObject xCableToCable1,
			EObject xContainer, EObject xDevice1, EObject cable1, EObject connection2, EObject xCableToCable2,
			EObject xCable, EObject xDevice2, EObject connection1, EObject device1, EObject device2,
			EObject xDeviceToDevice2) {
		_this.registerObjects_FWD(ruleresult, cable2, xDeviceToDevice, container, cableAttributes, xCableToCable1,
				xContainer, xDevice1, cable1, connection2, xCableToCable2, xCable, xDevice2, connection1, device1,
				device2, xDeviceToDevice2);
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_2_2_corematch_bindingFFFFFFFB(Match match) {
		...
		EObject _localVariable_6 = match.getObject("connection1");
					...
					if (tmpConnection2 instanceof Connections) {
						...
						if (tmpXCable instanceof XCable) {
							...
							if (tmpXDevice2 instanceof XDevice) {
								...
								if (tmpConnection1 instanceof Connections) {
									Connections connection1 = (Connections) tmpConnection1;
									return new Object[] { cableAttributes, xContainer, xDevice1, connection2, xCable,
											xDevice2, connection1, match };
								}
							}
						}
					}
	...
	public static final Iterable<Object[]> pattern_XDuplexConnectionToConnectionRule_2_2_corematch_blackFFBFBBFBFBBBFFFB(
			CableAttributes cableAttributes, XContainer xContainer, XDevice xDevice1, Connections connection2,
			XCable xCable, XDevice xDevice2, Connections connection1, Match match) {
												...
												if (!cable1.equals(cable2)) {
													for (XDeviceToDevice xDeviceToDevice2 : org.moflon.core.utilities.eMoflonEMFUtil
														...
														if (!xDeviceToDevice.equals(xDeviceToDevice2)) {
															...
															if (device2 != null) {
																if (!device1.equals(device2)) {
																	_result.add(new Object[] { cable2, xDeviceToDevice,
																			cableAttributes, xCableToCable1, xContainer,
																			xDevice1, cable1, connection2,
																			xCableToCable2, xCable, xDevice2,
																			connection1, device1, device2,
																			xDeviceToDevice2, match });
																}
															}
	...
	public static final Iterable<Object[]> pattern_XDuplexConnectionToConnectionRule_2_3_findcontext_blackBBFBBBBBBBBBBBBB(
			Cable cable2, XDeviceToDevice xDeviceToDevice, CableAttributes cableAttributes,
			XCableToCable xCableToCable1, XContainer xContainer, XDevice xDevice1, Cable cable1,
			Connections connection2, XCableToCable xCableToCable2, XCable xCable, XDevice xDevice2,
			Connections connection1, Device device1, Device device2, XDeviceToDevice xDeviceToDevice2) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_2_3_findcontext_greenBBBBBBBBBBBBBBBBFFFFFFFFFFFFFFFFFFFFFFF(
		...
		return new Object[] { cable2, xDeviceToDevice, container, cableAttributes, xCableToCable1, xContainer, xDevice1,
				cable1, connection2, xCableToCable2, xCable, xDevice2, connection1, device1, device2, xDeviceToDevice2,
				isApplicableMatch, cableAttributes__xDevice2____endPoint2, cableAttributes__xDevice1____endPoint1,
				xContainer__xDevice1____elements, xContainer__xDevice2____elements, xDeviceToDevice__xDevice1____source,
				xDevice1__connection1____connections, container__device1____devices, container__cable2____cables,
				xCableToCable1__cable1____target, xContainer__xCable____elements, container__cable1____cables,
				xCableToCable2__cable2____target, xCableToCable2__xCable____source, xCableToCable1__xCable____source,
				xCable__cableAttributes____cableAttributes, container__device2____devices,
				xDevice2__connection2____connections, connection2__xCable____incoming, connection1__xCable____outgoing,
				xDeviceToDevice__device1____target, xDeviceToDevice2__xDevice2____source,
				xDeviceToDevice2__device2____target };
	}

	public static final Object[] pattern_XDuplexConnectionToConnectionRule_2_4_solveCSP_bindingFBBBBBBBBBBBBBBBBBB(
			XDuplexConnectionToConnectionRule _this, IsApplicableMatch isApplicableMatch, Cable cable2,
			XDeviceToDevice xDeviceToDevice, Container container, CableAttributes cableAttributes,
			XCableToCable xCableToCable1, XContainer xContainer, XDevice xDevice1, Cable cable1,
			Connections connection2, XCableToCable xCableToCable2, XCable xCable, XDevice xDevice2,
			Connections connection1, Device device1, Device device2, XDeviceToDevice xDeviceToDevice2) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, cable2, xDeviceToDevice, container,
				cableAttributes, xCableToCable1, xContainer, xDevice1, cable1, connection2, xCableToCable2, xCable,
				xDevice2, connection1, device1, device2, xDeviceToDevice2);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, cable2, xDeviceToDevice, container, cableAttributes,
					xCableToCable1, xContainer, xDevice1, cable1, connection2, xCableToCable2, xCable, xDevice2,
					connection1, device1, device2, xDeviceToDevice2 };
		}
		return null;
	}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBBBBBBBBB(
		...
		Object[] result_pattern_XDuplexConnectionToConnectionRule_2_4_solveCSP_binding = pattern_XDuplexConnectionToConnectionRule_2_4_solveCSP_bindingFBBBBBBBBBBBBBBBBBB(
				_this, isApplicableMatch, cable2, xDeviceToDevice, container, cableAttributes, xCableToCable1,
				xContainer, xDevice1, cable1, connection2, xCableToCable2, xCable, xDevice2, connection1, device1,
				device2, xDeviceToDevice2);
		if (result_pattern_XDuplexConnectionToConnectionRule_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_XDuplexConnectionToConnectionRule_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, cable2, xDeviceToDevice, container,
						cableAttributes, xCableToCable1, xContainer, xDevice1, cable1, connection2, xCableToCable2,
						xCable, xDevice2, connection1, device1, device2, xDeviceToDevice2 };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_10_1_initialbindings_blackBBBBBBB(
			XDuplexConnectionToConnectionRule _this, Match match, Cable cable2, Container container, Cable cable1,
			Device device1, Device device2) {
		if (!cable1.equals(cable2)) {
			if (!device1.equals(device2)) {
				return new Object[] { _this, match, cable2, container, cable1, device1, device2 };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_10_2_SolveCSP_bindingFBBBBBBB(
			XDuplexConnectionToConnectionRule _this, Match match, Cable cable2, Container container, Cable cable1,
			Device device1, Device device2) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, cable2, container, cable1, device1, device2);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, cable2, container, cable1, device1, device2 };
		}
		return null;
	}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_XDuplexConnectionToConnectionRule_10_2_SolveCSP_binding = pattern_XDuplexConnectionToConnectionRule_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, cable2, container, cable1, device1, device2);
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_10_4_collectelementstobetranslated_blackBBBBBB(
			Match match, Cable cable2, Container container, Cable cable1, Device device1, Device device2) {
		if (!cable1.equals(cable2)) {
			if (!device1.equals(device2)) {
				return new Object[] { match, cable2, container, cable1, device1, device2 };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_10_4_collectelementstobetranslated_greenBBBBBFFFFFFFF(
			Match match, Cable cable2, Cable cable1, Device device1, Device device2) {
		EMoflonEdge cable2__device2____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge device2__cable2____outgoing = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge cable2__device1____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge device1__cable2____incoming = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		cable1__device1____source.setName(cable1__device1____source_name_prime);
		device1__cable1____outgoing.setName(device1__cable1____outgoing_name_prime);
		return new Object[] { match, cable2, cable1, device1, device2, cable2__device2____source,
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_10_5_collectcontextelements_greenBBBBBBFFFF(
		...
		container__cable1____cables.setName(container__cable1____cables_name_prime);
		container__device2____devices.setName(container__device2____devices_name_prime);
		return new Object[] { match, cable2, container, cable1, device1, device2, container__device1____devices,
				container__cable2____cables, container__cable1____cables, container__device2____devices };
	}

	public static final void pattern_XDuplexConnectionToConnectionRule_10_6_registerobjectstomatch_expressionBBBBBBB(
			XDuplexConnectionToConnectionRule _this, Match match, Cable cable2, Container container, Cable cable1,
			Device device1, Device device2) {
		_this.registerObjectsToMatch_BWD(match, cable2, container, cable1, device1, device2);
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFFFFFFFBB(
		...
		if (result_pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_binding != null) {
			Cable cable2 = (Cable) result_pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_binding[0];
			XDeviceToDevice xDeviceToDevice = (XDeviceToDevice) result_pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_binding[1];
			Container container = (Container) result_pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_binding[2];
			CableAttributes cableAttributes = (CableAttributes) result_pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_binding[3];
			XCableToCable xCableToCable1 = (XCableToCable) result_pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_binding[4];
			XContainer xContainer = (XContainer) result_pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_binding[5];
			XDevice xDevice1 = (XDevice) result_pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_binding[6];
			Cable cable1 = (Cable) result_pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_binding[7];
			Connections connection2 = (Connections) result_pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_binding[8];
			...
			XDevice xDevice2 = (XDevice) result_pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_binding[11];
			...
			Device device1 = (Device) result_pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_binding[13];
			Device device2 = (Device) result_pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_binding[14];
			XDeviceToDevice xDeviceToDevice2 = (XDeviceToDevice) result_pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_binding[15];
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_11_1_performtransformation_greenBBBBBB(
			CableAttributes cableAttributes, XDevice xDevice1, Connections connection2, XCable xCable, XDevice xDevice2,
			Connections connection1) {
		...
		return new Object[] { cableAttributes, xDevice1, connection2, xCable, xDevice2, connection1 };
	}
	...
	public static final void pattern_XDuplexConnectionToConnectionRule_11_5_registerobjects_expressionBBBBBBBBBBBBBBBBBB(
			...
			EObject xCable, EObject xDevice2, EObject connection1, EObject device1, EObject device2,
			EObject xDeviceToDevice2) {
		_this.registerObjects_BWD(ruleresult, cable2, xDeviceToDevice, container, cableAttributes, xCableToCable1,
				xContainer, xDevice1, cable1, connection2, xCableToCable2, xCable, xDevice2, connection1, device1,
				device2, xDeviceToDevice2);
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_12_2_corematch_bindingFFFFFB(Match match) {
		EObject _localVariable_0 = match.getObject("cable2");
		EObject _localVariable_1 = match.getObject("container");
		EObject _localVariable_2 = match.getObject("cable1");
		EObject _localVariable_3 = match.getObject("device1");
		EObject _localVariable_4 = match.getObject("device2");
		EObject tmpCable2 = _localVariable_0;
		EObject tmpContainer = _localVariable_1;
		EObject tmpCable1 = _localVariable_2;
			...
			if (tmpContainer instanceof Container) {
				...
				if (tmpCable1 instanceof Cable) {
					...
					if (tmpDevice1 instanceof Device) {
						...
						if (tmpDevice2 instanceof Device) {
							Device device2 = (Device) tmpDevice2;
							return new Object[] { cable2, container, cable1, device1, device2, match };
						}
					}
				}
			}
	...
	public static final Iterable<Object[]> pattern_XDuplexConnectionToConnectionRule_12_2_corematch_blackBFBFFBFFFBBFB(
			Cable cable2, Container container, Cable cable1, Device device1, Device device2, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!cable1.equals(cable2)) {
			if (!device1.equals(device2)) {
				for (XCableToCable xCableToCable1 : org.moflon.core.utilities.eMoflonEMFUtil
											...
											for (XDeviceToDevice xDeviceToDevice2 : org.moflon.core.utilities.eMoflonEMFUtil
												...
												if (!xDeviceToDevice.equals(xDeviceToDevice2)) {
													...
													if (xDevice2 != null) {
														if (!xDevice1.equals(xDevice2)) {
															_result.add(new Object[] { cable2, xDeviceToDevice,
																	container, xCableToCable1, xDevice1, cable1,
																	xCableToCable2, xCable, xDevice2, device1, device2,
																	xDeviceToDevice2, match });
														}
													}
	...
	public static final Iterable<Object[]> pattern_XDuplexConnectionToConnectionRule_12_3_findcontext_blackBBBFBFBBFBBBFBBB(
			Cable cable2, XDeviceToDevice xDeviceToDevice, Container container, XCableToCable xCableToCable1,
			XDevice xDevice1, Cable cable1, XCableToCable xCableToCable2, XCable xCable, XDevice xDevice2,
			Device device1, Device device2, XDeviceToDevice xDeviceToDevice2) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!xDeviceToDevice.equals(xDeviceToDevice2)) {
			if (!xCableToCable1.equals(xCableToCable2)) {
				if (!xDevice1.equals(xDevice2)) {
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_12_3_findcontext_greenBBBBBBBBBBBBBBBBFFFFFFFFFFFFFFFFFFFFFFFFFFF(
		...
		return new Object[] { cable2, xDeviceToDevice, container, cableAttributes, xCableToCable1, xContainer, xDevice1,
				cable1, connection2, xCableToCable2, xCable, xDevice2, connection1, device1, device2, xDeviceToDevice2,
				isApplicableMatch, cable2__device2____source, device2__cable2____outgoing,
				xContainer__xDevice1____elements, xContainer__xDevice2____elements, xDeviceToDevice__xDevice1____source,
				xDevice1__connection1____connections, container__device1____devices, cable2__device1____target,
				device1__cable2____incoming, container__cable2____cables, cable1__device2____target,
				device2__cable1____incoming, cable1__device1____source, device1__cable1____outgoing,
				xCableToCable1__cable1____target, xContainer__xCable____elements, container__cable1____cables,
				xCableToCable2__cable2____target, xCableToCable2__xCable____source, xCableToCable1__xCable____source,
				xCable__cableAttributes____cableAttributes, container__device2____devices,
				xDevice2__connection2____connections, xDeviceToDevice__device1____target,
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_12_4_solveCSP_bindingFBBBBBBBBBBBBBBBBBB(
			...
			Connections connection2, XCableToCable xCableToCable2, XCable xCable, XDevice xDevice2,
			Connections connection1, Device device1, Device device2, XDeviceToDevice xDeviceToDevice2) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, cable2, xDeviceToDevice, container,
				cableAttributes, xCableToCable1, xContainer, xDevice1, cable1, connection2, xCableToCable2, xCable,
				xDevice2, connection1, device1, device2, xDeviceToDevice2);
		CSP csp = _localVariable_0;
		if (csp != null) {
											...
											if (container.getDevices().contains(device1)) {
												if (container.getCables().contains(cable1)) {
													if (container.getDevices().contains(device2)) {
														_result.add(new Object[] { cable2, container, cable1, device1,
																device2, _edge_source });
													}
												}
											}
										}
	...
	public static final boolean pattern_XDuplexConnectionToConnectionRule_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			XDuplexConnectionToConnectionRule _this, Match match, Cable cable2, Container container, Cable cable1,
			Device device1, Device device2) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, cable2, container, cable1, device1, device2);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
												...
												if (cableAttributes.equals(xCable.getCableAttributes())) {
													if (connection1.getOutgoing().contains(xCable)) {
														for (XContainer xContainer : org.moflon.core.utilities.eMoflonEMFUtil
															...
															if (xContainer.getElements().contains(xDevice1)) {
																if (xContainer.getElements().contains(xCable)) {
																	_result.add(new Object[] { cableAttributes,
																			xContainer, xDevice1, connection2, xCable,
																			xDevice2, connection1, _edge_endPoint2 });
																}
															}
														}
													}
	...
	public static final boolean pattern_XDuplexConnectionToConnectionRule_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBBBB(
			...
			XContainer xContainer, XDevice xDevice1, Connections connection2, XCable xCable, XDevice xDevice2,
			Connections connection1) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, cableAttributes, xContainer, xDevice1, connection2,
				xCable, xDevice2, connection1);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_bindingFFFFFFFFFFFFBB(
		...
		EObject _localVariable_0 = targetMatch.getObject("cable2");
		EObject _localVariable_1 = targetMatch.getObject("container");
		EObject _localVariable_2 = sourceMatch.getObject("cableAttributes");
		EObject _localVariable_3 = sourceMatch.getObject("xContainer");
		EObject _localVariable_4 = sourceMatch.getObject("xDevice1");
		EObject _localVariable_5 = targetMatch.getObject("cable1");
		EObject _localVariable_6 = sourceMatch.getObject("connection2");
		EObject _localVariable_7 = sourceMatch.getObject("xCable");
		EObject _localVariable_8 = sourceMatch.getObject("xDevice2");
		EObject _localVariable_9 = sourceMatch.getObject("connection1");
		EObject _localVariable_10 = targetMatch.getObject("device1");
		EObject _localVariable_11 = targetMatch.getObject("device2");
		EObject tmpCable2 = _localVariable_0;
		EObject tmpContainer = _localVariable_1;
		EObject tmpCableAttributes = _localVariable_2;
		EObject tmpXContainer = _localVariable_3;
		EObject tmpXDevice1 = _localVariable_4;
		EObject tmpCable1 = _localVariable_5;
		EObject tmpConnection2 = _localVariable_6;
		EObject tmpXCable = _localVariable_7;
		EObject tmpXDevice2 = _localVariable_8;
		EObject tmpConnection1 = _localVariable_9;
		EObject tmpDevice1 = _localVariable_10;
										...
										if (tmpXDevice2 instanceof XDevice) {
											...
											if (tmpConnection1 instanceof Connections) {
												...
												if (tmpDevice1 instanceof Device) {
													...
													if (tmpDevice2 instanceof Device) {
														Device device2 = (Device) tmpDevice2;
														return new Object[] { cable2, container, cableAttributes,
																xContainer, xDevice1, cable1, connection2, xCable,
																xDevice2, connection1, device1, device2, targetMatch,
																sourceMatch };
													}
												}
											}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_blackBBBBBBBBBBBBBB(
			Cable cable2, Container container, CableAttributes cableAttributes, XContainer xContainer, XDevice xDevice1,
			Cable cable1, Connections connection2, XCable xCable, XDevice xDevice2, Connections connection1,
			Device device1, Device device2, Match sourceMatch, Match targetMatch) {
		if (!xDevice1.equals(xDevice2)) {
			if (!cable1.equals(cable2)) {
				if (!connection1.equals(connection2)) {
					if (!device1.equals(device2)) {
						if (!sourceMatch.equals(targetMatch)) {
							boolean cableAttributes_isDuplex = cableAttributes.isIsDuplex();
							if (Boolean.valueOf(cableAttributes_isDuplex).equals(Boolean.valueOf(true))) {
								return new Object[] { cable2, container, cableAttributes, xContainer, xDevice1, cable1,
										connection2, xCable, xDevice2, connection1, device1, device2, sourceMatch,
										targetMatch };
							}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFFFFFBB(
		...
		if (result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_binding != null) {
			Cable cable2 = (Cable) result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_binding[0];
			Container container = (Container) result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_binding[1];
			CableAttributes cableAttributes = (CableAttributes) result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_binding[2];
			XContainer xContainer = (XContainer) result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_binding[3];
			XDevice xDevice1 = (XDevice) result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_binding[4];
			Cable cable1 = (Cable) result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_binding[5];
			Connections connection2 = (Connections) result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_binding[6];
			XCable xCable = (XCable) result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_binding[7];
			XDevice xDevice2 = (XDevice) result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_binding[8];
			Connections connection1 = (Connections) result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_binding[9];
			Device device1 = (Device) result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_binding[10];
			Device device2 = (Device) result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_binding[11];
			...
			Object[] result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_black = pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_blackBBBBBBBBBBBBBB(
					cable2, container, cableAttributes, xContainer, xDevice1, cable1, connection2, xCable, xDevice2,
					connection1, device1, device2, sourceMatch, targetMatch);
			if (result_pattern_XDuplexConnectionToConnectionRule_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { cable2, container, cableAttributes, xContainer, xDevice1, cable1, connection2,
						xCable, xDevice2, connection1, device1, device2, sourceMatch, targetMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_24_3_solvecsp_bindingFBBBBBBBBBBBBBBB(
			XDuplexConnectionToConnectionRule _this, Cable cable2, Container container, CableAttributes cableAttributes,
			XContainer xContainer, XDevice xDevice1, Cable cable1, Connections connection2, XCable xCable,
			XDevice xDevice2, Connections connection1, Device device1, Device device2, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_12 = _this.isApplicable_solveCsp_CC(cable2, container, cableAttributes, xContainer, xDevice1,
				cable1, connection2, xCable, xDevice2, connection1, device1, device2, sourceMatch, targetMatch);
		CSP csp = _localVariable_12;
		if (csp != null) {
			return new Object[] { csp, _this, cable2, container, cableAttributes, xContainer, xDevice1, cable1,
					connection2, xCable, xDevice2, connection1, device1, device2, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBBBBBB(
		...
		Object[] result_pattern_XDuplexConnectionToConnectionRule_24_3_solvecsp_binding = pattern_XDuplexConnectionToConnectionRule_24_3_solvecsp_bindingFBBBBBBBBBBBBBBB(
				_this, cable2, container, cableAttributes, xContainer, xDevice1, cable1, connection2, xCable, xDevice2,
				connection1, device1, device2, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_XDuplexConnectionToConnectionRule_24_5_matchcorrcontext_blackBFFBBFBBBBFBB(
			Cable cable2, XDevice xDevice1, Cable cable1, XCable xCable, XDevice xDevice2, Device device1,
			Device device2, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!xDevice1.equals(xDevice2)) {
			if (!cable1.equals(cable2)) {
				if (!device1.equals(device2)) {
													...
													for (XDeviceToDevice xDeviceToDevice2 : org.moflon.core.utilities.eMoflonEMFUtil
														...
														if (!xDeviceToDevice.equals(xDeviceToDevice2)) {
															if (device2.equals(xDeviceToDevice2.getTarget())) {
																_result.add(new Object[] { cable2, xDeviceToDevice,
																		xCableToCable1, xDevice1, cable1,
																		xCableToCable2, xCable, xDevice2, device1,
																		device2, xDeviceToDevice2, sourceMatch,
																		targetMatch });
															}
														}
													}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_24_6_createcorrespondence_blackBBBBBBBBBBBBB(
			Cable cable2, Container container, CableAttributes cableAttributes, XContainer xContainer, XDevice xDevice1,
			Cable cable1, Connections connection2, XCable xCable, XDevice xDevice2, Connections connection1,
			Device device1, Device device2, CCMatch ccMatch) {
		if (!xDevice1.equals(xDevice2)) {
			if (!cable1.equals(cable2)) {
				if (!connection1.equals(connection2)) {
					if (!device1.equals(device2)) {
						return new Object[] { cable2, container, cableAttributes, xContainer, xDevice1, cable1,
								connection2, xCable, xDevice2, connection1, device1, device2, ccMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_27_1_matchtggpattern_blackBBBBBBB(
			CableAttributes cableAttributes, XContainer xContainer, XDevice xDevice1, Connections connection2,
			XCable xCable, XDevice xDevice2, Connections connection1) {
		if (!xDevice1.equals(xDevice2)) {
			if (!connection1.equals(connection2)) {
				if (xDevice2.equals(cableAttributes.getEndPoint2())) {
					if (xDevice1.equals(cableAttributes.getEndPoint1())) {
										...
										if (cableAttributes.equals(xCable.getCableAttributes())) {
											if (connection2.equals(xDevice2.getConnections())) {
												if (connection2.getIncoming().contains(xCable)) {
													if (connection1.getOutgoing().contains(xCable)) {
														return new Object[] { cableAttributes, xContainer, xDevice1,
																connection2, xCable, xDevice2, connection1 };
													}
												}
											}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_28_1_matchtggpattern_blackBBBBB(Cable cable2,
			Container container, Cable cable1, Device device1, Device device2) {
		if (!cable1.equals(cable2)) {
			if (!device1.equals(device2)) {
				if (device2.equals(cable2.getSource())) {
					if (container.getDevices().contains(device1)) {
							...
							if (container.getCables().contains(cable2)) {
								if (device2.equals(cable1.getTarget())) {
									if (device1.equals(cable1.getSource())) {
										if (container.getCables().contains(cable1)) {
											if (container.getDevices().contains(device2)) {
												return new Object[] { cable2, container, cable1, device1, device2 };
											}
										}
									}
								}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_29_3_solveCSP_bindingFBBBBBBBBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, cable2, xDeviceToDevice, container,
				cableAttributes, xCableToCable1, xContainer, xDevice1, cable1, connection2, xCableToCable2, xCable,
				xDevice2, connection1, device1, device2, xDeviceToDevice2, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, cable2, xDeviceToDevice, container, cableAttributes,
					xCableToCable1, xContainer, xDevice1, cable1, connection2, xCableToCable2, xCable, xDevice2,
					connection1, device1, device2, xDeviceToDevice2, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBBBBBBBBB(
		...
		if (result_pattern_XDuplexConnectionToConnectionRule_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_XDuplexConnectionToConnectionRule_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, cable2, xDeviceToDevice, container,
						cableAttributes, xCableToCable1, xContainer, xDevice1, cable1, connection2, xCableToCable2,
						xCable, xDevice2, connection1, device1, device2, xDeviceToDevice2, ruleResult };
			}
		}
		return null;
	}
				...
				if (!xDevice1.equals(xDevice2)) {
					if (!cable1.equals(cable2)) {
						if (!connection1.equals(connection2)) {
							if (!device1.equals(device2)) {
								return new Object[] { cable2, xDeviceToDevice, container, cableAttributes,
										xCableToCable1, xContainer, xDevice1, cable1, connection2, xCableToCable2,
										xCable, xDevice2, connection1, device1, device2, xDeviceToDevice2 };
							}
						}
					}
	...
	public static final Object[] pattern_XDuplexConnectionToConnectionRule_29_6_perform_greenBBBBBBBBBBB(Cable cable2,
			CableAttributes cableAttributes, XDevice xDevice1, Cable cable1, Connections connection2, XCable xCable,
		...
		return new Object[] { cable2, cableAttributes, xDevice1, cable1, connection2, xCable, xDevice2, connection1,
				device1, device2, ruleResult };
	}
