...
public class ImplementationTransformatorTrafo extends SynchronizationHelper{

   public ImplementationTransformatorTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        ImplementationTransformatorTrafo helper = new ImplementationTransformatorTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new ImplementationTransformatorTrafo();
