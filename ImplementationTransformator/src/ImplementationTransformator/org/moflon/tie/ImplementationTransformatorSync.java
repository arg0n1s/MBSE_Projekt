...
public class ImplementationTransformatorSync extends SynchronizationHelper{

   public ImplementationTransformatorSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ImplementationTransformatorSync helper = new ImplementationTransformatorSync();
