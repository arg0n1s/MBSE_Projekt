...
public class ImplementationTransformatorModelGen extends SynchronizationHelper{

   public ImplementationTransformatorModelGen()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ModelGenerator gen = new ModelGenerator(ImplementationTransformatorPackage.eINSTANCE, controller);
		gen.generate();
	}
}