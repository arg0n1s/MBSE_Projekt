 ...
 * </p>
 * <ul>
 *   <li>{@link implementation.impl.RouterImpl#getMaxSpeed <em>Max Speed</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RouterImpl extends DeviceImpl implements Router {
	...
	protected EClass eStaticClass() {
		return ImplementationPackage.Literals.ROUTER;
	}
	...
	public void setMaxSpeed(BigInteger newMaxSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImplementationPackage.ROUTER__MAX_SPEED, oldMaxSpeed, maxSpeed));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ImplementationPackage.ROUTER__MAX_SPEED:
				return getMaxSpeed();
		}
