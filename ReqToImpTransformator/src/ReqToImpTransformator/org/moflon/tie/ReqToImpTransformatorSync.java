...
public class ReqToImpTransformatorSync extends SynchronizationHelper{

   public ReqToImpTransformatorSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ReqToImpTransformatorSync helper = new ReqToImpTransformatorSync();
