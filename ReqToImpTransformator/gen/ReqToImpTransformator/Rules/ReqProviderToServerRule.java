...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Req Provider To Server Rule</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see ReqToImpTransformator.Rules.RulesPackage#getReqProviderToServerRule()
 * @model
 * @generated
 */
public interface ReqProviderToServerRule extends EObject, AbstractRule {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model
	 * @generated
	 */
	boolean isAppropriate_FWD(Match match, Provider reqAgent, Container reqContainer, NetworkSpan virtualNode);
	 ...
	 * @generated
	 */
	void registerObjectsToMatch_FWD(Match match, Provider reqAgent, Container reqContainer, NetworkSpan virtualNode);
	 ...
	 * @generated
	 */
	CSP isAppropriate_solveCsp_FWD(Match match, Provider reqAgent, Container reqContainer, NetworkSpan virtualNode);
	 ...
	 * @generated
	 */
	boolean isAppropriate_BWD(Match match, Server implDevice, Cable cable, implementation.Container implContainer);
	 ...
	 * @generated
	 */
	void registerObjectsToMatch_BWD(Match match, Server implDevice, Cable cable,
	 ...
	 * @generated
	 */
	CSP isAppropriate_solveCsp_BWD(Match match, Server implDevice, Cable cable, implementation.Container implContainer);
	 ...
	 * @generated
	 */
	CSP isApplicable_solveCsp_CC(Server implDevice, Provider reqAgent, Container reqContainer, NetworkSpan virtualNode,
			Cable cable, implementation.Container implContainer, Match sourceMatch, Match targetMatch);
	 ...
	 * @generated
	 */
	boolean checkDEC_FWD(Provider reqAgent, Container reqContainer, NetworkSpan virtualNode);
	 ...
	 * @generated
	 */
	boolean checkDEC_BWD(Server implDevice, Cable cable, implementation.Container implContainer);
