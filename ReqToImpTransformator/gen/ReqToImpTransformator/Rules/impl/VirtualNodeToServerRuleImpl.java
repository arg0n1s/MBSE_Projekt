...
public class VirtualNodeToServerRuleImpl extends AbstractRuleImpl implements VirtualNodeToServerRule {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, implementation.Container implContainer, Router router, Cable cable,
			Server server) {
		...
		if (VirtualNodeToServerRuleImpl.pattern_VirtualNodeToServerRule_7_3_CheckCSP_expressionFBB(this, csp)) {
			...
			VirtualNodeToServerRuleImpl.pattern_VirtualNodeToServerRule_7_6_registerobjectstomatch_expressionBBBBBB(
					this, match, implContainer, router, cable, server);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		VirtualNodeToRouter virtualNodeToRouter = (VirtualNodeToRouter) result1_bindingAndBlack[3];
		Container reqContainer = (Container) result1_bindingAndBlack[4];
		...
		Object[] result3_black = VirtualNodeToServerRuleImpl
				.pattern_VirtualNodeToServerRule_8_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, implContainer,
						virtualNode, router, virtualNodeToRouter, reqContainer, virtualNodeToServer, cable,
						reqContainerToImplContainer, server);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[reqContainer] = " + reqContainer + ", " + "[virtualNodeToServer] = " + virtualNodeToServer
					+ ", " + "[cable] = " + cable + ", " + "[reqContainerToImplContainer] = "
					+ reqContainerToImplContainer + ", " + "[server] = " + server + ".");
		}
		VirtualNodeToServerRuleImpl.pattern_VirtualNodeToServerRule_8_3_bookkeepingforedges_greenBBBBBBBFFFFFFF(
				ruleresult, implContainer, virtualNode, router, virtualNodeToServer, cable, server);
		...
		VirtualNodeToServerRuleImpl.pattern_VirtualNodeToServerRule_8_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, implContainer, virtualNode, router, virtualNodeToRouter, reqContainer, virtualNodeToServer,
				cable, reqContainerToImplContainer, server);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : VirtualNodeToServerRuleImpl
				.pattern_VirtualNodeToServerRule_9_2_corematch_blackBFBFFBFBB(implContainer, router, cable, server,
						match)) {
			...
			for (Object[] result3_black : VirtualNodeToServerRuleImpl
					.pattern_VirtualNodeToServerRule_9_3_findcontext_blackBBBBBBBB(implContainer, virtualNode, router,
							virtualNodeToRouter, reqContainer, cable, reqContainerToImplContainer, server)) {
				Object[] result3_green = VirtualNodeToServerRuleImpl
						.pattern_VirtualNodeToServerRule_9_3_findcontext_greenBBBBBBBBFFFFFFFFFFFFF(implContainer,
								virtualNode, router, virtualNodeToRouter, reqContainer, cable,
								reqContainerToImplContainer, server);
				...
				//nothing EMoflonEdge router__cable____incoming = (EMoflonEdge) result3_green[11];
				//nothing EMoflonEdge cable__router____target = (EMoflonEdge) result3_green[12];
				//nothing EMoflonEdge virtualNodeToRouter__router____target = (EMoflonEdge) result3_green[13];
				//nothing EMoflonEdge reqContainer__virtualNode____networkSpan = (EMoflonEdge) result3_green[14];
				//nothing EMoflonEdge implContainer__server____devices = (EMoflonEdge) result3_green[15];
				//nothing EMoflonEdge reqContainerToImplContainer__reqContainer____source = (EMoflonEdge) result3_green[16];
				//nothing EMoflonEdge reqContainerToImplContainer__implContainer____target = (EMoflonEdge) result3_green[17];
				//nothing EMoflonEdge virtualNodeToRouter__virtualNode____source = (EMoflonEdge) result3_green[18];
				//nothing EMoflonEdge server__cable____outgoing = (EMoflonEdge) result3_green[19];
				//nothing EMoflonEdge cable__server____source = (EMoflonEdge) result3_green[20];
				...
				Object[] result4_bindingAndBlack = VirtualNodeToServerRuleImpl
						.pattern_VirtualNodeToServerRule_9_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this,
								isApplicableMatch, implContainer, virtualNode, router, virtualNodeToRouter,
								reqContainer, cable, reqContainerToImplContainer, server);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ reqContainer + ", " + "[cable] = " + cable + ", " + "[reqContainerToImplContainer] = "
							+ reqContainerToImplContainer + ", " + "[server] = " + server + ".");
				}
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, implementation.Container implContainer,
			NetworkSpan virtualNode, Router router, VirtualNodeToRouter virtualNodeToRouter, Container reqContainer,
			Cable cable, ReqContainerToImplContainer reqContainerToImplContainer, Server server) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject implContainer, EObject virtualNode,
			EObject router, EObject virtualNodeToRouter, EObject reqContainer, EObject virtualNodeToServer,
			EObject cable, EObject reqContainerToImplContainer, EObject server) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_1(EMoflonEdge _edge_incoming) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = VirtualNodeToServerRuleImpl
				.pattern_VirtualNodeToServerRule_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, implContainer,
						virtualNode, router, reqContainer, cable, server, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[implContainer] = " + implContainer + ", " + "[virtualNode] = " + virtualNode + ", "
					+ "[router] = " + router + ", " + "[reqContainer] = " + reqContainer + ", " + "[cable] = " + cable
		...
		if (VirtualNodeToServerRuleImpl.pattern_VirtualNodeToServerRule_21_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : VirtualNodeToServerRuleImpl
					.pattern_VirtualNodeToServerRule_21_5_matchcorrcontext_blackBBBFBFBB(implContainer, virtualNode,
				...
				Object[] result6_black = VirtualNodeToServerRuleImpl
						.pattern_VirtualNodeToServerRule_21_6_createcorrespondence_blackBBBBBBB(implContainer,
								virtualNode, router, reqContainer, cable, server, ccMatch);
				if (result6_black == null) {
	...
	public CSP isApplicable_solveCsp_CC(implementation.Container implContainer, NetworkSpan virtualNode, Router router,
			Container reqContainer, Cable cable, Server server, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(implementation.Container implContainer, Router router, Cable cable, Server server) {// 
		Object[] result1_black = VirtualNodeToServerRuleImpl
				.pattern_VirtualNodeToServerRule_25_1_matchtggpattern_blackBBBB(implContainer, router, cable, server);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : VirtualNodeToServerRuleImpl
			...
			Container reqContainer = (Container) result2_black[5];
			ReqContainerToImplContainer reqContainerToImplContainer = (ReqContainerToImplContainer) result2_black[6];
			...
			Object[] result3_bindingAndBlack = VirtualNodeToServerRuleImpl
					.pattern_VirtualNodeToServerRule_26_3_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
							implContainer, virtualNode, router, virtualNodeToRouter, reqContainer, cable,
			...
			if (VirtualNodeToServerRuleImpl.pattern_VirtualNodeToServerRule_26_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = VirtualNodeToServerRuleImpl
						.pattern_VirtualNodeToServerRule_26_5_checknacs_blackBBBBBBB(implContainer, virtualNode, router,
								virtualNodeToRouter, reqContainer, cable, reqContainerToImplContainer);
				if (result5_black != null) {

					Object[] result6_black = VirtualNodeToServerRuleImpl
							.pattern_VirtualNodeToServerRule_26_6_perform_blackBBBBBBBB(implContainer, virtualNode,
									router, virtualNodeToRouter, reqContainer, cable, reqContainerToImplContainer,
									ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[implContainer] = "
								+ implContainer + ", " + "[virtualNode] = " + virtualNode + ", " + "[router] = "
								+ router + ", " + "[virtualNodeToRouter] = " + virtualNodeToRouter + ", "
								+ "[reqContainer] = " + reqContainer + ", " + "[cable] = " + cable + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.VIRTUAL_NODE_TO_SERVER_RULE___IS_APPROPRIATE_BWD__MATCH_CONTAINER_ROUTER_CABLE_SERVER:
			return isAppropriate_BWD((Match) arguments.get(0), (implementation.Container) arguments.get(1),
					(Router) arguments.get(2), (Cable) arguments.get(3), (Server) arguments.get(4));
		...
		case RulesPackage.VIRTUAL_NODE_TO_SERVER_RULE___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_CONTAINER_ROUTER_CABLE_SERVER:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (implementation.Container) arguments.get(1),
					(Router) arguments.get(2), (Cable) arguments.get(3), (Server) arguments.get(4));
			return null;
		case RulesPackage.VIRTUAL_NODE_TO_SERVER_RULE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_CONTAINER_ROUTER_CABLE_SERVER:
		...
		case RulesPackage.VIRTUAL_NODE_TO_SERVER_RULE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CONTAINER_NETWORKSPAN_ROUTER_VIRTUALNODETOROUTER_CONTAINER_CABLE_REQCONTAINERTOIMPLCONTAINER_SERVER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(implementation.Container) arguments.get(1), (NetworkSpan) arguments.get(2),
					(Router) arguments.get(3), (VirtualNodeToRouter) arguments.get(4), (Container) arguments.get(5),
					(Cable) arguments.get(6), (ReqContainerToImplContainer) arguments.get(7),
					(Server) arguments.get(8));
		...
		case RulesPackage.VIRTUAL_NODE_TO_SERVER_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_1__EMOFLONEDGE:
		...
		case RulesPackage.VIRTUAL_NODE_TO_SERVER_RULE___IS_APPLICABLE_SOLVE_CSP_CC__CONTAINER_NETWORKSPAN_ROUTER_CONTAINER_CABLE_SERVER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((implementation.Container) arguments.get(0), (NetworkSpan) arguments.get(1),
					(Router) arguments.get(2), (Container) arguments.get(3), (Cable) arguments.get(4),
		...
		case RulesPackage.VIRTUAL_NODE_TO_SERVER_RULE___CHECK_DEC_BWD__CONTAINER_ROUTER_CABLE_SERVER:
		...
		case RulesPackage.VIRTUAL_NODE_TO_SERVER_RULE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CONTAINER_NETWORKSPAN_ROUTER_VIRTUALNODETOROUTER_CONTAINER_CABLE_REQCONTAINERTOIMPLCONTAINER_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_VirtualNodeToServerRule_7_1_initialbindings_blackBBBBBB(
			...
			Cable cable, Server server) {
		return new Object[] { _this, match, implContainer, router, cable, server };
	}

	public static final Object[] pattern_VirtualNodeToServerRule_7_2_SolveCSP_bindingFBBBBBB(
			VirtualNodeToServerRule _this, Match match, implementation.Container implContainer, Router router,
			Cable cable, Server server) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, implContainer, router, cable, server);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, implContainer, router, cable, server };
		}
		return null;
	}
	...
	public static final Object[] pattern_VirtualNodeToServerRule_7_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_VirtualNodeToServerRule_7_2_SolveCSP_binding = pattern_VirtualNodeToServerRule_7_2_SolveCSP_bindingFBBBBBB(
				_this, match, implContainer, router, cable, server);
	...
	public static final Object[] pattern_VirtualNodeToServerRule_7_4_collectelementstobetranslated_blackBBBBB(
			Match match, implementation.Container implContainer, Router router, Cable cable, Server server) {
		return new Object[] { match, implContainer, router, cable, server };
	}
	...
	public static final Object[] pattern_VirtualNodeToServerRule_7_4_collectelementstobetranslated_greenBBBBBFFFFF(
		...
		return new Object[] { match, implContainer, router, cable, server, router__cable____incoming,
	...
	public static final Object[] pattern_VirtualNodeToServerRule_7_5_collectcontextelements_blackBBBBB(Match match,
			implementation.Container implContainer, Router router, Cable cable, Server server) {
		return new Object[] { match, implContainer, router, cable, server };
	}
	...
	public static final Object[] pattern_VirtualNodeToServerRule_7_5_collectcontextelements_greenBBBBFF(Match match,
		...
		return new Object[] { match, implContainer, router, cable, implContainer__router____devices,
	...
	public static final void pattern_VirtualNodeToServerRule_7_6_registerobjectstomatch_expressionBBBBBB(
			VirtualNodeToServerRule _this, Match match, implementation.Container implContainer, Router router,
			Cable cable, Server server) {
		_this.registerObjectsToMatch_BWD(match, implContainer, router, cable, server);
	...
	public static final Object[] pattern_VirtualNodeToServerRule_8_1_performtransformation_bindingFFFFFFFFB(
		...
		EObject _localVariable_3 = isApplicableMatch.getObject("virtualNodeToRouter");
		EObject _localVariable_4 = isApplicableMatch.getObject("reqContainer");
		...
		EObject tmpVirtualNodeToRouter = _localVariable_3;
		EObject tmpReqContainer = _localVariable_4;
							...
							if (tmpCable instanceof Cable) {
								...
								if (tmpReqContainerToImplContainer instanceof ReqContainerToImplContainer) {
									...
									if (tmpServer instanceof Server) {
										...
										return new Object[] { implContainer, virtualNode, router, virtualNodeToRouter,
												reqContainer, cable, reqContainerToImplContainer, server,
												isApplicableMatch };
									}
								}
	...
	public static final Object[] pattern_VirtualNodeToServerRule_8_1_performtransformation_blackBBBBBBBBFBB(
			...
			VirtualNodeToRouter virtualNodeToRouter, Container reqContainer, Cable cable,
			ReqContainerToImplContainer reqContainerToImplContainer, Server server, VirtualNodeToServerRule _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { implContainer, virtualNode, router, virtualNodeToRouter, reqContainer, cable,
						reqContainerToImplContainer, server, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_VirtualNodeToServerRule_8_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
		...
		if (result_pattern_VirtualNodeToServerRule_8_1_performtransformation_binding != null) {
			...
			VirtualNodeToRouter virtualNodeToRouter = (VirtualNodeToRouter) result_pattern_VirtualNodeToServerRule_8_1_performtransformation_binding[3];
			Container reqContainer = (Container) result_pattern_VirtualNodeToServerRule_8_1_performtransformation_binding[4];
			Cable cable = (Cable) result_pattern_VirtualNodeToServerRule_8_1_performtransformation_binding[5];
			ReqContainerToImplContainer reqContainerToImplContainer = (ReqContainerToImplContainer) result_pattern_VirtualNodeToServerRule_8_1_performtransformation_binding[6];
			...
			Object[] result_pattern_VirtualNodeToServerRule_8_1_performtransformation_black = pattern_VirtualNodeToServerRule_8_1_performtransformation_blackBBBBBBBBFBB(
					implContainer, virtualNode, router, virtualNodeToRouter, reqContainer, cable,
					reqContainerToImplContainer, server, _this, isApplicableMatch);
	...
	public static final Object[] pattern_VirtualNodeToServerRule_8_3_bookkeepingforedges_blackBBBBBBBBBB(
			...
			EObject virtualNodeToRouter, EObject reqContainer, EObject virtualNodeToServer, EObject cable,
			EObject reqContainerToImplContainer, EObject server) {
	...
	public static final Object[] pattern_VirtualNodeToServerRule_8_3_bookkeepingforedges_greenBBBBBBBFFFFFFF(
		...
		server__cable____outgoing.setName(server__cable____outgoing_name_prime);
		cable__server____source.setName(cable__server____source_name_prime);
		return new Object[] { ruleresult, implContainer, virtualNode, router, virtualNodeToServer, cable, server,
	...
	public static final void pattern_VirtualNodeToServerRule_8_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject router, EObject virtualNodeToRouter, EObject reqContainer, EObject virtualNodeToServer,
			EObject cable, EObject reqContainerToImplContainer, EObject server) {
		_this.registerObjects_BWD(ruleresult, implContainer, virtualNode, router, virtualNodeToRouter, reqContainer,
				virtualNodeToServer, cable, reqContainerToImplContainer, server);
		...
		if (tmpImplContainer instanceof implementation.Container) {
			...
			if (tmpRouter instanceof Router) {
				...
				if (tmpCable instanceof Cable) {
					...
					if (tmpServer instanceof Server) {
						Server server = (Server) tmpServer;
						return new Object[] { implContainer, router, cable, server, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_VirtualNodeToServerRule_9_2_corematch_blackBFBFFBFBB(
			implementation.Container implContainer, Router router, Cable cable, Server server, Match match) {
			...
			if (virtualNode != null) {
				for (ReqContainerToImplContainer reqContainerToImplContainer : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (reqContainer != null) {
						_result.add(new Object[] { implContainer, virtualNode, router, virtualNodeToRouter,
								reqContainer, cable, reqContainerToImplContainer, server, match });
					}
	...
	public static final Iterable<Object[]> pattern_VirtualNodeToServerRule_9_3_findcontext_blackBBBBBBBB(
			implementation.Container implContainer, NetworkSpan virtualNode, Router router,
			VirtualNodeToRouter virtualNodeToRouter, Container reqContainer, Cable cable,
			ReqContainerToImplContainer reqContainerToImplContainer, Server server) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
										...
										if (virtualNode.equals(virtualNodeToRouter.getSource())) {
											if (server.getOutgoing().contains(cable)) {
												_result.add(new Object[] { implContainer, virtualNode, router,
														virtualNodeToRouter, reqContainer, cable,
														reqContainerToImplContainer, server });
											}
										}
									}
	...
	public static final Object[] pattern_VirtualNodeToServerRule_9_3_findcontext_greenBBBBBBBBFFFFFFFFFFFFF(
		...
		cable__server____source.setName(cable__server____source_name_prime);
		return new Object[] { implContainer, virtualNode, router, virtualNodeToRouter, reqContainer, cable,
				reqContainerToImplContainer, server, isApplicableMatch, implContainer__router____devices,
				implContainer__cable____cables, router__cable____incoming, cable__router____target,
				virtualNodeToRouter__router____target, reqContainer__virtualNode____networkSpan,
				implContainer__server____devices, reqContainerToImplContainer__reqContainer____source,
				reqContainerToImplContainer__implContainer____target, virtualNodeToRouter__virtualNode____source,
	...
	public static final Object[] pattern_VirtualNodeToServerRule_9_4_solveCSP_bindingFBBBBBBBBBB(
			...
			NetworkSpan virtualNode, Router router, VirtualNodeToRouter virtualNodeToRouter, Container reqContainer,
			Cable cable, ReqContainerToImplContainer reqContainerToImplContainer, Server server) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, implContainer, virtualNode, router,
				virtualNodeToRouter, reqContainer, cable, reqContainerToImplContainer, server);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, implContainer, virtualNode, router,
					virtualNodeToRouter, reqContainer, cable, reqContainerToImplContainer, server };
		}
		return null;
	}
	...
	public static final Object[] pattern_VirtualNodeToServerRule_9_4_solveCSP_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_VirtualNodeToServerRule_9_4_solveCSP_binding = pattern_VirtualNodeToServerRule_9_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, implContainer, virtualNode, router, virtualNodeToRouter, reqContainer, cable,
				reqContainerToImplContainer, server);
				...
				if (router.getIncoming().contains(cable)) {
					...
					if (tmpServer instanceof Server) {
						...
						for (implementation.Container implContainer : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (implContainer.getCables().contains(cable)) {
								if (implContainer.getDevices().contains(server)) {
									_result.add(new Object[] { implContainer, router, cable, server, _edge_incoming });
								}
							}
						}
					}
	...
	public static final boolean pattern_VirtualNodeToServerRule_18_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			VirtualNodeToServerRule _this, Match match, implementation.Container implContainer, Router router,
			Cable cable, Server server) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, implContainer, router, cable, server);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
				...
				if (tmpRouter instanceof Router) {
					...
					if (tmpReqContainer instanceof Container) {
						...
						if (tmpCable instanceof Cable) {
							...
							if (tmpServer instanceof Server) {
								Server server = (Server) tmpServer;
								return new Object[] { implContainer, virtualNode, router, reqContainer, cable, server,
	...
	public static final Object[] pattern_VirtualNodeToServerRule_21_2_matchsrctrgcontext_blackBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { implContainer, virtualNode, router, reqContainer, cable, server, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_VirtualNodeToServerRule_21_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_VirtualNodeToServerRule_21_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_VirtualNodeToServerRule_21_2_matchsrctrgcontext_black = pattern_VirtualNodeToServerRule_21_2_matchsrctrgcontext_blackBBBBBBBB(
					implContainer, virtualNode, router, reqContainer, cable, server, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_VirtualNodeToServerRule_21_3_solvecsp_bindingFBBBBBBBBB(
			...
			Router router, Container reqContainer, Cable cable, Server server, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(implContainer, virtualNode, router, reqContainer, cable,
				server, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, implContainer, virtualNode, router, reqContainer, cable, server,
	...
	public static final Object[] pattern_VirtualNodeToServerRule_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_VirtualNodeToServerRule_21_3_solvecsp_binding = pattern_VirtualNodeToServerRule_21_3_solvecsp_bindingFBBBBBBBBB(
				_this, implContainer, virtualNode, router, reqContainer, cable, server, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_VirtualNodeToServerRule_21_5_matchcorrcontext_blackBBBFBFBB(
			implementation.Container implContainer, NetworkSpan virtualNode, Router router, Container reqContainer,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_VirtualNodeToServerRule_21_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { implContainer, virtualNode, router, reqContainer, cable, server, ccMatch };
	}
		...
		if (implContainer.getDevices().contains(router)) {
			if (implContainer.getCables().contains(cable)) {
				if (router.getIncoming().contains(cable)) {
					if (implContainer.getDevices().contains(server)) {
						if (server.getOutgoing().contains(cable)) {
							return new Object[] { implContainer, router, cable, server };
						}
					}
				}
			}
																	...
																	if (reqContainer.equals(
																		...
																		if (pattern_VirtualNodeToServerRule_26_2_isapplicablecore_black_nac_5BB(
																			...
																			_result.add(new Object[] {
																					...
																					reqContainer,
																					reqContainerToImplContainer, cable,
	...
	public static final Object[] pattern_VirtualNodeToServerRule_26_3_solveCSP_bindingFBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, implContainer, virtualNode, router,
				virtualNodeToRouter, reqContainer, cable, reqContainerToImplContainer, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, implContainer, virtualNode, router,
					virtualNodeToRouter, reqContainer, cable, reqContainerToImplContainer, ruleResult };
	...
	public static final Object[] pattern_VirtualNodeToServerRule_26_6_perform_greenBBBFBFB(
		...
		return new Object[] { implContainer, virtualNode, router, virtualNodeToServer, cable, server, ruleResult };
	}
