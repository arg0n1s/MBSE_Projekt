...
public class VirtualNodeToRouterRule2Impl extends AbstractRuleImpl implements VirtualNodeToRouterRule2 {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Cable cable, Router router, Router router2,
			implementation.Container implContainer) {

		Object[] result1_black = VirtualNodeToRouterRule2Impl
				.pattern_VirtualNodeToRouterRule2_7_1_initialbindings_blackBBBBBB(this, match, cable, router, router2,
						implContainer);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[cable] = " + cable + ", " + "[router] = " + router + ", "
					+ "[router2] = " + router2 + ", " + "[implContainer] = " + implContainer + ".");
		}

		Object[] result2_bindingAndBlack = VirtualNodeToRouterRule2Impl
				.pattern_VirtualNodeToRouterRule2_7_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, cable, router,
						router2, implContainer);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[cable] = " + cable + ", " + "[router] = " + router + ", "
					+ "[router2] = " + router2 + ", " + "[implContainer] = " + implContainer + ".");
		...
		if (VirtualNodeToRouterRule2Impl.pattern_VirtualNodeToRouterRule2_7_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = VirtualNodeToRouterRule2Impl
					.pattern_VirtualNodeToRouterRule2_7_4_collectelementstobetranslated_blackBBBBB(match, cable, router,
							router2, implContainer);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[cable] = " + cable + ", " + "[router] = " + router + ", " + "[router2] = " + router2 + ", "
						+ "[implContainer] = " + implContainer + ".");
			}
			VirtualNodeToRouterRule2Impl
					.pattern_VirtualNodeToRouterRule2_7_4_collectelementstobetranslated_greenBBBBBFFFFF(match, cable,
							router, router2, implContainer);
			...
			//nothing EMoflonEdge router2__cable____incoming = (EMoflonEdge) result4_green[7];
			//nothing EMoflonEdge cable__router2____target = (EMoflonEdge) result4_green[8];
			//nothing EMoflonEdge implContainer__router2____devices = (EMoflonEdge) result4_green[9];

			Object[] result5_black = VirtualNodeToRouterRule2Impl
					.pattern_VirtualNodeToRouterRule2_7_5_collectcontextelements_blackBBBBB(match, cable, router,
							router2, implContainer);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[cable] = " + cable + ", " + "[router] = " + router + ", " + "[router2] = " + router2 + ", "
			...
			VirtualNodeToRouterRule2Impl.pattern_VirtualNodeToRouterRule2_7_6_registerobjectstomatch_expressionBBBBBB(
					this, match, cable, router, router2, implContainer);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		VirtualNodeToRouter virtualNodeToRouter1 = (VirtualNodeToRouter) result1_bindingAndBlack[4];
		Router router = (Router) result1_bindingAndBlack[5];
		Router router2 = (Router) result1_bindingAndBlack[6];
		...
		Object[] result3_black = VirtualNodeToRouterRule2Impl
				.pattern_VirtualNodeToRouterRule2_8_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, cable,
						virtualNode, reqContainerToImplContainer, reqContainer, virtualNodeToRouter1, router, router2,
						implContainer, virtualNodeToRouter);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[cable] = " + cable + ", " + "[virtualNode] = " + virtualNode + ", "
					+ "[reqContainerToImplContainer] = " + reqContainerToImplContainer + ", " + "[reqContainer] = "
					+ reqContainer + ", " + "[virtualNodeToRouter1] = " + virtualNodeToRouter1 + ", " + "[router] = "
					+ router + ", " + "[router2] = " + router2 + ", " + "[implContainer] = " + implContainer + ", "
					+ "[virtualNodeToRouter] = " + virtualNodeToRouter + ".");
		}
		VirtualNodeToRouterRule2Impl.pattern_VirtualNodeToRouterRule2_8_3_bookkeepingforedges_greenBBBBBBBFFFFFFF(
				ruleresult, cable, virtualNode, router, router2, implContainer, virtualNodeToRouter);
		...
		//nothing EMoflonEdge virtualNodeToRouter__router2____target = (EMoflonEdge) result3_green[12];
		...
		VirtualNodeToRouterRule2Impl.pattern_VirtualNodeToRouterRule2_8_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, cable, virtualNode, reqContainerToImplContainer, reqContainer, virtualNodeToRouter1, router,
				router2, implContainer, virtualNodeToRouter);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		implementation.Container implContainer = (implementation.Container) result2_binding[3];
		for (Object[] result2_black : VirtualNodeToRouterRule2Impl
				.pattern_VirtualNodeToRouterRule2_9_2_corematch_blackBFFFFBBBB(cable, router, router2, implContainer,
						match)) {
			...
			for (Object[] result3_black : VirtualNodeToRouterRule2Impl
					.pattern_VirtualNodeToRouterRule2_9_3_findcontext_blackBBBBBBBB(cable, virtualNode,
							reqContainerToImplContainer, reqContainer, virtualNodeToRouter1, router, router2,
							implContainer)) {
				Object[] result3_green = VirtualNodeToRouterRule2Impl
						.pattern_VirtualNodeToRouterRule2_9_3_findcontext_greenBBBBBBBBFFFFFFFFFFFFF(cable, virtualNode,
								reqContainerToImplContainer, reqContainer, virtualNodeToRouter1, router, router2,
								implContainer);
				...
				//nothing EMoflonEdge virtualNodeToRouter1__virtualNode____source = (EMoflonEdge) result3_green[11];
				//nothing EMoflonEdge virtualNodeToRouter1__router____target = (EMoflonEdge) result3_green[12];
				//nothing EMoflonEdge router__cable____outgoing = (EMoflonEdge) result3_green[13];
				//nothing EMoflonEdge cable__router____source = (EMoflonEdge) result3_green[14];
				...
				//nothing EMoflonEdge router2__cable____incoming = (EMoflonEdge) result3_green[17];
				//nothing EMoflonEdge cable__router2____target = (EMoflonEdge) result3_green[18];
				//nothing EMoflonEdge reqContainerToImplContainer__implContainer____target = (EMoflonEdge) result3_green[19];
				//nothing EMoflonEdge implContainer__router2____devices = (EMoflonEdge) result3_green[20];
				...
				Object[] result4_bindingAndBlack = VirtualNodeToRouterRule2Impl
						.pattern_VirtualNodeToRouterRule2_9_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this,
								isApplicableMatch, cable, virtualNode, reqContainerToImplContainer, reqContainer,
								virtualNodeToRouter1, router, router2, implContainer);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[cable] = " + cable + ", "
							+ "[virtualNode] = " + virtualNode + ", " + "[reqContainerToImplContainer] = "
							+ reqContainerToImplContainer + ", " + "[reqContainer] = " + reqContainer + ", "
							+ "[virtualNodeToRouter1] = " + virtualNodeToRouter1 + ", " + "[router] = " + router + ", "
							+ "[router2] = " + router2 + ", " + "[implContainer] = " + implContainer + ".");
				}
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, Cable cable, Router router, Router router2,
			implementation.Container implContainer) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, Cable cable, Router router, Router router2,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Cable cable, NetworkSpan virtualNode,
			ReqContainerToImplContainer reqContainerToImplContainer, Container reqContainer,
			VirtualNodeToRouter virtualNodeToRouter1, Router router, Router router2,
			implementation.Container implContainer) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject cable, EObject virtualNode,
			EObject reqContainerToImplContainer, EObject reqContainer, EObject virtualNodeToRouter1, EObject router,
			EObject router2, EObject implContainer, EObject virtualNodeToRouter) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_4(EMoflonEdge _edge_outgoing) {
		...
		// ForEach 
		for (Object[] result2_black : VirtualNodeToRouterRule2Impl
				.pattern_VirtualNodeToRouterRule2_18_2_testcorematchandDECs_blackFFFFB(_edge_outgoing)) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Router router2 = (Router) result2_bindingAndBlack[4];
		...
		Object[] result3_bindingAndBlack = VirtualNodeToRouterRule2Impl
				.pattern_VirtualNodeToRouterRule2_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, cable, virtualNode,
						reqContainer, router, router2, implContainer, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[cable] = " + cable + ", " + "[virtualNode] = " + virtualNode + ", " + "[reqContainer] = "
					+ reqContainer + ", " + "[router] = " + router + ", " + "[router2] = " + router2 + ", "
		...
		if (VirtualNodeToRouterRule2Impl.pattern_VirtualNodeToRouterRule2_21_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : VirtualNodeToRouterRule2Impl
					.pattern_VirtualNodeToRouterRule2_21_5_matchcorrcontext_blackBFBFBBBB(virtualNode, reqContainer,
				...
				VirtualNodeToRouter virtualNodeToRouter1 = (VirtualNodeToRouter) result5_black[3];
				...
				Object[] result6_black = VirtualNodeToRouterRule2Impl
						.pattern_VirtualNodeToRouterRule2_21_6_createcorrespondence_blackBBBBBBB(cable, virtualNode,
								reqContainer, router, router2, implContainer, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[cable] = " + cable + ", "
							+ "[virtualNode] = " + virtualNode + ", " + "[reqContainer] = " + reqContainer + ", "
							+ "[router] = " + router + ", " + "[router2] = " + router2 + ", " + "[implContainer] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Cable cable, NetworkSpan virtualNode, Container reqContainer, Router router,
			Router router2, implementation.Container implContainer, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Cable cable, Router router, Router router2, implementation.Container implContainer) {// 
		Object[] result1_black = VirtualNodeToRouterRule2Impl
				.pattern_VirtualNodeToRouterRule2_25_1_matchtggpattern_blackBBBB(cable, router, router2, implContainer);
		if (result1_black != null) {
		...
		for (Object[] result2_black : VirtualNodeToRouterRule2Impl
			...
			Object[] result3_bindingAndBlack = VirtualNodeToRouterRule2Impl
					.pattern_VirtualNodeToRouterRule2_26_3_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
							cable, virtualNode, reqContainerToImplContainer, reqContainer, virtualNodeToRouter1, router,
			...
			if (VirtualNodeToRouterRule2Impl.pattern_VirtualNodeToRouterRule2_26_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = VirtualNodeToRouterRule2Impl
						.pattern_VirtualNodeToRouterRule2_26_5_checknacs_blackBBBBBBB(cable, virtualNode,
								reqContainerToImplContainer, reqContainer, virtualNodeToRouter1, router, implContainer);
				if (result5_black != null) {

					Object[] result6_black = VirtualNodeToRouterRule2Impl
							.pattern_VirtualNodeToRouterRule2_26_6_perform_blackBBBBBBBB(cable, virtualNode,
									reqContainerToImplContainer, reqContainer, virtualNodeToRouter1, router,
									implContainer, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[cable] = " + cable
								+ ", " + "[virtualNode] = " + virtualNode + ", " + "[reqContainerToImplContainer] = "
					...
					VirtualNodeToRouterRule2Impl.pattern_VirtualNodeToRouterRule2_26_6_perform_greenBBBFBFB(cable,
							virtualNode, router, implContainer, ruleResult);
					//nothing Router router2 = (Router) result6_green[3];
					//nothing VirtualNodeToRouter virtualNodeToRouter = (VirtualNodeToRouter) result6_green[5];
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Cable cable, NetworkSpan virtualNode,
			ReqContainerToImplContainer reqContainerToImplContainer, Container reqContainer,
			VirtualNodeToRouter virtualNodeToRouter1, Router router, implementation.Container implContainer,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.VIRTUAL_NODE_TO_ROUTER_RULE2___IS_APPROPRIATE_BWD__MATCH_CABLE_ROUTER_ROUTER_CONTAINER:
			return isAppropriate_BWD((Match) arguments.get(0), (Cable) arguments.get(1), (Router) arguments.get(2),
					(Router) arguments.get(3), (implementation.Container) arguments.get(4));
		...
		case RulesPackage.VIRTUAL_NODE_TO_ROUTER_RULE2___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_CABLE_ROUTER_ROUTER_CONTAINER:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (Cable) arguments.get(1), (Router) arguments.get(2),
					(Router) arguments.get(3), (implementation.Container) arguments.get(4));
			return null;
		case RulesPackage.VIRTUAL_NODE_TO_ROUTER_RULE2___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_CABLE_ROUTER_ROUTER_CONTAINER:
			return isAppropriate_solveCsp_BWD((Match) arguments.get(0), (Cable) arguments.get(1),
					(Router) arguments.get(2), (Router) arguments.get(3), (implementation.Container) arguments.get(4));
		case RulesPackage.VIRTUAL_NODE_TO_ROUTER_RULE2___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
			return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.VIRTUAL_NODE_TO_ROUTER_RULE2___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CABLE_NETWORKSPAN_REQCONTAINERTOIMPLCONTAINER_CONTAINER_VIRTUALNODETOROUTER_ROUTER_ROUTER_CONTAINER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Cable) arguments.get(1),
					(NetworkSpan) arguments.get(2), (ReqContainerToImplContainer) arguments.get(3),
					(Container) arguments.get(4), (VirtualNodeToRouter) arguments.get(5), (Router) arguments.get(6),
					(Router) arguments.get(7), (implementation.Container) arguments.get(8));
		...
		case RulesPackage.VIRTUAL_NODE_TO_ROUTER_RULE2___IS_APPROPRIATE_BWD_EMOFLON_EDGE_4__EMOFLONEDGE:
		...
		case RulesPackage.VIRTUAL_NODE_TO_ROUTER_RULE2___IS_APPLICABLE_SOLVE_CSP_CC__CABLE_NETWORKSPAN_CONTAINER_ROUTER_ROUTER_CONTAINER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Cable) arguments.get(0), (NetworkSpan) arguments.get(1),
					(Container) arguments.get(2), (Router) arguments.get(3), (Router) arguments.get(4),
		...
		case RulesPackage.VIRTUAL_NODE_TO_ROUTER_RULE2___CHECK_DEC_BWD__CABLE_ROUTER_ROUTER_CONTAINER:
			return checkDEC_BWD((Cable) arguments.get(0), (Router) arguments.get(1), (Router) arguments.get(2),
		...
		case RulesPackage.VIRTUAL_NODE_TO_ROUTER_RULE2___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CABLE_NETWORKSPAN_REQCONTAINERTOIMPLCONTAINER_CONTAINER_VIRTUALNODETOROUTER_ROUTER_CONTAINER_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_7_1_initialbindings_blackBBBBBB(
			VirtualNodeToRouterRule2 _this, Match match, Cable cable, Router router, Router router2,
			implementation.Container implContainer) {
		if (!router.equals(router2)) {
			return new Object[] { _this, match, cable, router, router2, implContainer };
		}
		return null;
	}
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_7_2_SolveCSP_bindingFBBBBBB(
			VirtualNodeToRouterRule2 _this, Match match, Cable cable, Router router, Router router2,
			implementation.Container implContainer) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, cable, router, router2, implContainer);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, cable, router, router2, implContainer };
		}
		return null;
	}
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_7_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_VirtualNodeToRouterRule2_7_2_SolveCSP_binding = pattern_VirtualNodeToRouterRule2_7_2_SolveCSP_bindingFBBBBBB(
				_this, match, cable, router, router2, implContainer);
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_7_4_collectelementstobetranslated_blackBBBBB(
			Match match, Cable cable, Router router, Router router2, implementation.Container implContainer) {
		if (!router.equals(router2)) {
			return new Object[] { match, cable, router, router2, implContainer };
		}
		return null;
	}
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_7_4_collectelementstobetranslated_greenBBBBBFFFFF(
		...
		return new Object[] { match, cable, router, router2, implContainer, router__cable____outgoing,
				cable__router____source, router2__cable____incoming, cable__router2____target,
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_7_5_collectcontextelements_blackBBBBB(Match match,
			Cable cable, Router router, Router router2, implementation.Container implContainer) {
		if (!router.equals(router2)) {
			return new Object[] { match, cable, router, router2, implContainer };
		}
		return null;
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_7_5_collectcontextelements_greenBBBBFF(Match match,
		...
		return new Object[] { match, cable, router, implContainer, implContainer__cable____cables,
	...
	public static final void pattern_VirtualNodeToRouterRule2_7_6_registerobjectstomatch_expressionBBBBBB(
			VirtualNodeToRouterRule2 _this, Match match, Cable cable, Router router, Router router2,
			implementation.Container implContainer) {
		_this.registerObjectsToMatch_BWD(match, cable, router, router2, implContainer);
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_8_1_performtransformation_bindingFFFFFFFFB(
		...
		EObject _localVariable_4 = isApplicableMatch.getObject("virtualNodeToRouter1");
		EObject _localVariable_5 = isApplicableMatch.getObject("router");
		EObject _localVariable_6 = isApplicableMatch.getObject("router2");
		...
		EObject tmpVirtualNodeToRouter1 = _localVariable_4;
		EObject tmpRouter = _localVariable_5;
		EObject tmpRouter2 = _localVariable_6;
							...
							if (tmpRouter instanceof Router) {
								...
								if (tmpRouter2 instanceof Router) {
									...
									if (tmpImplContainer instanceof implementation.Container) {
										...
										return new Object[] { cable, virtualNode, reqContainerToImplContainer,
												reqContainer, virtualNodeToRouter1, router, router2, implContainer,
												isApplicableMatch };
									}
								}
							}
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_8_1_performtransformation_blackBBBBBBBBFBB(
			Cable cable, NetworkSpan virtualNode, ReqContainerToImplContainer reqContainerToImplContainer,
			Container reqContainer, VirtualNodeToRouter virtualNodeToRouter1, Router router, Router router2,
			implementation.Container implContainer, VirtualNodeToRouterRule2 _this,
			IsApplicableMatch isApplicableMatch) {
		if (!router.equals(router2)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { cable, virtualNode, reqContainerToImplContainer, reqContainer,
							virtualNodeToRouter1, router, router2, implContainer, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_8_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
		...
		if (result_pattern_VirtualNodeToRouterRule2_8_1_performtransformation_binding != null) {
			Cable cable = (Cable) result_pattern_VirtualNodeToRouterRule2_8_1_performtransformation_binding[0];
			NetworkSpan virtualNode = (NetworkSpan) result_pattern_VirtualNodeToRouterRule2_8_1_performtransformation_binding[1];
			...
			VirtualNodeToRouter virtualNodeToRouter1 = (VirtualNodeToRouter) result_pattern_VirtualNodeToRouterRule2_8_1_performtransformation_binding[4];
			Router router = (Router) result_pattern_VirtualNodeToRouterRule2_8_1_performtransformation_binding[5];
			Router router2 = (Router) result_pattern_VirtualNodeToRouterRule2_8_1_performtransformation_binding[6];
			implementation.Container implContainer = (implementation.Container) result_pattern_VirtualNodeToRouterRule2_8_1_performtransformation_binding[7];
			...
			Object[] result_pattern_VirtualNodeToRouterRule2_8_1_performtransformation_black = pattern_VirtualNodeToRouterRule2_8_1_performtransformation_blackBBBBBBBBFBB(
					cable, virtualNode, reqContainerToImplContainer, reqContainer, virtualNodeToRouter1, router,
					router2, implContainer, _this, isApplicableMatch);
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_8_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject cable, EObject virtualNode, EObject reqContainerToImplContainer,
			EObject reqContainer, EObject virtualNodeToRouter1, EObject router, EObject router2, EObject implContainer,
			EObject virtualNodeToRouter) {
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_8_3_bookkeepingforedges_greenBBBBBBBFFFFFFF(
			PerformRuleResult ruleresult, EObject cable, EObject virtualNode, EObject router, EObject router2,
			EObject implContainer, EObject virtualNodeToRouter) {
		EMoflonEdge router__cable____outgoing = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge cable__router____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge router2__cable____incoming = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge cable__router2____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, cable, virtualNode, router, router2, implContainer, virtualNodeToRouter,
				router__cable____outgoing, cable__router____source, router2__cable____incoming,
				cable__router2____target, implContainer__router2____devices, virtualNodeToRouter__router2____target,
	...
	public static final void pattern_VirtualNodeToRouterRule2_8_5_registerobjects_expressionBBBBBBBBBBB(
			VirtualNodeToRouterRule2 _this, PerformRuleResult ruleresult, EObject cable, EObject virtualNode,
			EObject reqContainerToImplContainer, EObject reqContainer, EObject virtualNodeToRouter1, EObject router,
			EObject router2, EObject implContainer, EObject virtualNodeToRouter) {
		_this.registerObjects_BWD(ruleresult, cable, virtualNode, reqContainerToImplContainer, reqContainer,
				virtualNodeToRouter1, router, router2, implContainer, virtualNodeToRouter);
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_9_2_corematch_bindingFFFFB(Match match) {
		...
		EObject _localVariable_3 = match.getObject("implContainer");
		EObject tmpCable = _localVariable_0;
		...
		if (tmpCable instanceof Cable) {
			...
			if (tmpRouter instanceof Router) {
				...
				if (tmpRouter2 instanceof Router) {
					...
					if (tmpImplContainer instanceof implementation.Container) {
						implementation.Container implContainer = (implementation.Container) tmpImplContainer;
						return new Object[] { cable, router, router2, implContainer, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_VirtualNodeToRouterRule2_9_2_corematch_blackBFFFFBBBB(Cable cable,
			Router router, Router router2, implementation.Container implContainer, Match match) {
				...
				if (virtualNode != null) {
					for (ReqContainerToImplContainer reqContainerToImplContainer : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (reqContainer != null) {
							_result.add(new Object[] { cable, virtualNode, reqContainerToImplContainer, reqContainer,
									virtualNodeToRouter1, router, router2, implContainer, match });
						}
	...
	public static final Iterable<Object[]> pattern_VirtualNodeToRouterRule2_9_3_findcontext_blackBBBBBBBB(Cable cable,
			NetworkSpan virtualNode, ReqContainerToImplContainer reqContainerToImplContainer, Container reqContainer,
			VirtualNodeToRouter virtualNodeToRouter1, Router router, Router router2,
			implementation.Container implContainer) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!router.equals(router2)) {
										...
										if (router2.getIncoming().contains(cable)) {
											if (implContainer.equals(reqContainerToImplContainer.getTarget())) {
												if (implContainer.getDevices().contains(router2)) {
													_result.add(new Object[] { cable, virtualNode,
															reqContainerToImplContainer, reqContainer,
															virtualNodeToRouter1, router, router2, implContainer });
												}
											}
										}
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_9_3_findcontext_greenBBBBBBBBFFFFFFFFFFFFF(
		...
		implContainer__router2____devices.setName(implContainer__router2____devices_name_prime);
		return new Object[] { cable, virtualNode, reqContainerToImplContainer, reqContainer, virtualNodeToRouter1,
				router, router2, implContainer, isApplicableMatch, reqContainerToImplContainer__reqContainer____source,
				reqContainer__virtualNode____networkSpan, virtualNodeToRouter1__virtualNode____source,
				virtualNodeToRouter1__router____target, router__cable____outgoing, cable__router____source,
				implContainer__cable____cables, implContainer__router____devices, router2__cable____incoming,
				cable__router2____target, reqContainerToImplContainer__implContainer____target,
				implContainer__router2____devices };
	}

	public static final Object[] pattern_VirtualNodeToRouterRule2_9_4_solveCSP_bindingFBBBBBBBBBB(
			VirtualNodeToRouterRule2 _this, IsApplicableMatch isApplicableMatch, Cable cable, NetworkSpan virtualNode,
			ReqContainerToImplContainer reqContainerToImplContainer, Container reqContainer,
			VirtualNodeToRouter virtualNodeToRouter1, Router router, Router router2,
			implementation.Container implContainer) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, cable, virtualNode,
				reqContainerToImplContainer, reqContainer, virtualNodeToRouter1, router, router2, implContainer);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, cable, virtualNode, reqContainerToImplContainer,
					reqContainer, virtualNodeToRouter1, router, router2, implContainer };
		}
		return null;
	}
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_9_4_solveCSP_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_VirtualNodeToRouterRule2_9_4_solveCSP_binding = pattern_VirtualNodeToRouterRule2_9_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, cable, virtualNode, reqContainerToImplContainer, reqContainer,
				virtualNodeToRouter1, router, router2, implContainer);
	...
	public static final Iterable<Object[]> pattern_VirtualNodeToRouterRule2_18_2_testcorematchandDECs_blackFFFFB(
		...
		if (tmpRouter instanceof Router) {
			...
			if (tmpCable instanceof Cable) {
				Cable cable = (Cable) tmpCable;
				if (router.getOutgoing().contains(cable)) {
					Device tmpRouter2 = cable.getTarget();
					if (tmpRouter2 instanceof Router) {
						Router router2 = (Router) tmpRouter2;
						if (!router.equals(router2)) {
							for (implementation.Container implContainer : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (implContainer.getCables().contains(cable)) {
									if (implContainer.getDevices().contains(router2)) {
										_result.add(
												new Object[] { cable, router, router2, implContainer, _edge_outgoing });
									}
								}
							}
						}
	...
	public static final boolean pattern_VirtualNodeToRouterRule2_18_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			VirtualNodeToRouterRule2 _this, Match match, Cable cable, Router router, Router router2,
			implementation.Container implContainer) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, cable, router, router2, implContainer);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_21_2_matchsrctrgcontext_bindingFFFFFFBB(
		...
		EObject _localVariable_4 = targetMatch.getObject("router2");
		...
		EObject tmpRouter2 = _localVariable_4;
				...
				if (tmpReqContainer instanceof Container) {
					...
					if (tmpRouter instanceof Router) {
						...
						if (tmpRouter2 instanceof Router) {
							...
							if (tmpImplContainer instanceof implementation.Container) {
								implementation.Container implContainer = (implementation.Container) tmpImplContainer;
								return new Object[] { cable, virtualNode, reqContainer, router, router2, implContainer,
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_21_2_matchsrctrgcontext_blackBBBBBBBB(Cable cable,
			NetworkSpan virtualNode, Container reqContainer, Router router, Router router2,
			implementation.Container implContainer, Match sourceMatch, Match targetMatch) {
		if (!router.equals(router2)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { cable, virtualNode, reqContainer, router, router2, implContainer, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_21_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_VirtualNodeToRouterRule2_21_2_matchsrctrgcontext_binding != null) {
			Cable cable = (Cable) result_pattern_VirtualNodeToRouterRule2_21_2_matchsrctrgcontext_binding[0];
			...
			Router router = (Router) result_pattern_VirtualNodeToRouterRule2_21_2_matchsrctrgcontext_binding[3];
			Router router2 = (Router) result_pattern_VirtualNodeToRouterRule2_21_2_matchsrctrgcontext_binding[4];
			implementation.Container implContainer = (implementation.Container) result_pattern_VirtualNodeToRouterRule2_21_2_matchsrctrgcontext_binding[5];
			...
			Object[] result_pattern_VirtualNodeToRouterRule2_21_2_matchsrctrgcontext_black = pattern_VirtualNodeToRouterRule2_21_2_matchsrctrgcontext_blackBBBBBBBB(
					cable, virtualNode, reqContainer, router, router2, implContainer, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_21_3_solvecsp_bindingFBBBBBBBBB(
			VirtualNodeToRouterRule2 _this, Cable cable, NetworkSpan virtualNode, Container reqContainer, Router router,
			Router router2, implementation.Container implContainer, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(cable, virtualNode, reqContainer, router, router2,
				implContainer, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, cable, virtualNode, reqContainer, router, router2, implContainer,
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_VirtualNodeToRouterRule2_21_3_solvecsp_binding = pattern_VirtualNodeToRouterRule2_21_3_solvecsp_bindingFBBBBBBBBB(
				_this, cable, virtualNode, reqContainer, router, router2, implContainer, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_VirtualNodeToRouterRule2_21_5_matchcorrcontext_blackBFBFBBBB(
			NetworkSpan virtualNode, Container reqContainer, Router router, implementation.Container implContainer,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (ReqContainerToImplContainer reqContainerToImplContainer : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (implContainer.equals(reqContainerToImplContainer.getTarget())) {
					for (VirtualNodeToRouter virtualNodeToRouter1 : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (router.equals(virtualNodeToRouter1.getTarget())) {
							_result.add(new Object[] { virtualNode, reqContainerToImplContainer, reqContainer,
									virtualNodeToRouter1, router, implContainer, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_21_6_createcorrespondence_blackBBBBBBB(Cable cable,
			NetworkSpan virtualNode, Container reqContainer, Router router, Router router2,
			implementation.Container implContainer, CCMatch ccMatch) {
		if (!router.equals(router2)) {
			return new Object[] { cable, virtualNode, reqContainer, router, router2, implContainer, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_25_1_matchtggpattern_blackBBBB(Cable cable,
			Router router, Router router2, implementation.Container implContainer) {
		if (!router.equals(router2)) {
			if (router.getOutgoing().contains(cable)) {
				if (implContainer.getCables().contains(cable)) {
					if (implContainer.getDevices().contains(router)) {
						if (router2.getIncoming().contains(cable)) {
							if (implContainer.getDevices().contains(router2)) {
								return new Object[] { cable, router, router2, implContainer };
							}
						}
					}
				}
			...
			for (EObject tmpVirtualNodeToRouter1 : virtualNodeToRouter1List.getEntryObjects()) {
				if (tmpVirtualNodeToRouter1 instanceof VirtualNodeToRouter) {
					...
					if (router != null) {
						NetworkSpan virtualNode = virtualNodeToRouter1.getSource();
						if (virtualNode != null) {
							if (pattern_VirtualNodeToRouterRule2_26_2_isapplicablecore_black_nac_3BB(ruleResult,
									virtualNodeToRouter1) == null) {
								if (pattern_VirtualNodeToRouterRule2_26_2_isapplicablecore_black_nac_2BB(ruleResult,
										router) == null) {
									if (pattern_VirtualNodeToRouterRule2_26_2_isapplicablecore_black_nac_4BB(ruleResult,
											virtualNode) == null) {
										for (implementation.Container implContainer : org.moflon.core.utilities.eMoflonEMFUtil
												.getOppositeReferenceTyped(router, implementation.Container.class,
														"devices")) {
											if (pattern_VirtualNodeToRouterRule2_26_2_isapplicablecore_black_nac_1BB(
													ruleResult, implContainer) == null) {
												for (Cable cable : implContainer.getCables()) {
													if (pattern_VirtualNodeToRouterRule2_26_2_isapplicablecore_black_nac_0BB(
																	...
																	if (reqContainer.equals(
																		...
																		if (pattern_VirtualNodeToRouterRule2_26_2_isapplicablecore_black_nac_6BB(
																			...
																			_result.add(new Object[] {
																					virtualNodeToRouter1List, cable,
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_26_3_solveCSP_bindingFBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, cable, virtualNode,
				reqContainerToImplContainer, reqContainer, virtualNodeToRouter1, router, implContainer, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, cable, virtualNode, reqContainerToImplContainer,
					reqContainer, virtualNodeToRouter1, router, implContainer, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_26_3_solveCSP_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_VirtualNodeToRouterRule2_26_3_solveCSP_binding = pattern_VirtualNodeToRouterRule2_26_3_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, cable, virtualNode, reqContainerToImplContainer, reqContainer,
				virtualNodeToRouter1, router, implContainer, ruleResult);
	...
	public static final Object[] pattern_VirtualNodeToRouterRule2_26_5_checknacs_blackBBBBBBB(Cable cable,
			NetworkSpan virtualNode, ReqContainerToImplContainer reqContainerToImplContainer, Container reqContainer,
			VirtualNodeToRouter virtualNodeToRouter1, Router router, implementation.Container implContainer) {
		return new Object[] { cable, virtualNode, reqContainerToImplContainer, reqContainer, virtualNodeToRouter1,
				router, implContainer };
	}

	public static final Object[] pattern_VirtualNodeToRouterRule2_26_6_perform_blackBBBBBBBB(Cable cable,
			NetworkSpan virtualNode, ReqContainerToImplContainer reqContainerToImplContainer, Container reqContainer,
			VirtualNodeToRouter virtualNodeToRouter1, Router router, implementation.Container implContainer,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { cable, virtualNode, reqContainerToImplContainer, reqContainer, virtualNodeToRouter1,
				router, implContainer, ruleResult };
	}

	public static final Object[] pattern_VirtualNodeToRouterRule2_26_6_perform_greenBBBFBFB(Cable cable,
			NetworkSpan virtualNode, Router router, implementation.Container implContainer,
			ModelgeneratorRuleResult ruleResult) {
		...
		return new Object[] { cable, virtualNode, router, router2, implContainer, virtualNodeToRouter, ruleResult };
	}
