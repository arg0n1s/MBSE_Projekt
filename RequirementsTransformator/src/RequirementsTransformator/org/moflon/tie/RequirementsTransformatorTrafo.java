...
public class RequirementsTransformatorTrafo extends SynchronizationHelper{

   public RequirementsTransformatorTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        RequirementsTransformatorTrafo helper = new RequirementsTransformatorTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new RequirementsTransformatorTrafo();
