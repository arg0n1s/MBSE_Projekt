...
public class RequirementsTransformatorConsistencyCheck extends SynchronizationHelper{

   public RequirementsTransformatorConsistencyCheck()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        RequirementsTransformatorConsistencyCheck helper = new RequirementsTransformatorConsistencyCheck();
