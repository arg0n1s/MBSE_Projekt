...
public class RequirementsTransformatorSync extends SynchronizationHelper{

   public RequirementsTransformatorSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		RequirementsTransformatorSync helper = new RequirementsTransformatorSync();
