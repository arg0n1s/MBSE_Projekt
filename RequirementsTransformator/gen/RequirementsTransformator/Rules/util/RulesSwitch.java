/**
 */
package RequirementsTransformator.Rules.util;
...
public class RulesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case RulesPackage.XAGENT_TO_AGENT_RULE: {
			...
			if (result == null)
				result = caseAbstractRule(xAgentToAgentRule);
			if (result == null)
		...
		case RulesPackage.XCONSUMER_TO_CONSUMER_RULE: {
			XConsumerToConsumerRule xConsumerToConsumerRule = (XConsumerToConsumerRule) theEObject;
			T result = caseXConsumerToConsumerRule(xConsumerToConsumerRule);
			if (result == null)
				result = caseAbstractRule(xConsumerToConsumerRule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>XAgent To Agent Rule</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>XAgent To Agent Rule</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseXAgentToAgentRule(XAgentToAgentRule object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>XConsumer To Consumer Rule</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>XConsumer To Consumer Rule</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
