...
public class InternalXtextImplParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'incoming'", "'('", "','", "')'", "'outgoing'", "'true'", "'false'", "'speed'", "'endPoint1'", "'endPoint2'", "'isDuplex'", "'Server'", "'{'", "'maxSlots'", "'MTBF'", "'}'", "'Computer'", "'Router'", "'maxSpeed'", "'CopperCable'", "'GlassFiberCable'"
    };
    ...
    public static final BitSet FOLLOW_16 = new BitSet(new long[]{0x0000000004008800L});
